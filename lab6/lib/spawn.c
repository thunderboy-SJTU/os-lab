...
static int init_stack_2(envid_t envid, const char **argv, uintptr_t *init_esp,uint32_t stack);
...
static int
init_stack_2(envid_t envid, const char **argv, uintptr_t *init_esp,uint32_t stack)
{
	size_t string_size;
	int argc, i, r;
	char *string_store;
