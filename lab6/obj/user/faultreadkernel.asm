	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800270:	0f be 80 91 27 80 00 	movsbl 0x802791(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800426:	c7 44 24 08 a2 27 80 	movl   $0x8027a2,0x8(%esp)
  80042d:	00 
  ...
  80048a:	be ab 27 80 00       	mov    $0x8027ab,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800789:	0f be 80 91 27 80 00 	movsbl 0x802791(%eax),%eax
  ...
  800908:	0f be 80 91 27 80 00 	movsbl 0x802791(%eax),%eax
  ...
  80094a:	0f be 80 91 27 80 00 	movsbl 0x802791(%eax),%eax
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  802346:	e8 79 dd ff ff       	call   8000c4 <vcprintf>
	cprintf("\n");
  80234b:	c7 04 24 a4 2b 80 00 	movl   $0x802ba4,(%esp)
