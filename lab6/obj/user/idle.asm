...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 30 80 00 40 	movl   $0x802740,0x803000
  800041:	27 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 1c 06 00 00       	call   800665 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  80005e:	e8 84 06 00 00       	call   8006e7 <sys_getenvid>
...
exit(void)
{
  ...
  8000a3:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a6:	e8 d0 0b 00 00       	call   800c7b <close_all>
	sys_env_destroy(0);
  8000ab:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000b2:	e8 70 06 00 00       	call   800727 <sys_env_destroy>
}
  8000b7:	c9                   	leave  
  8000b8:	c3                   	ret    
...
sys_cgetc(void)
{
  ...
  8000c5:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000e0:	54                   	push   %esp
  8000e1:	5d                   	pop    %ebp
  8000e2:	8d 35 ea 00 80 00    	lea    0x8000ea,%esi
  8000e8:	0f 34                	sysenter 
  8000ea:	5f                   	pop    %edi
  8000eb:	5e                   	pop    %esi
  8000ec:	5d                   	pop    %ebp
  8000ed:	5c                   	pop    %esp
...
sys_cgetc(void)
{
  ...
  8000f1:	8b 1c 24             	mov    (%esp),%ebx
  8000f4:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8000f8:	89 ec                	mov    %ebp,%esp
  8000fa:	5d                   	pop    %ebp
  8000fb:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  800105:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
sys_cputs(const char *s, size_t len)
{
  ...
  800133:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800137:	89 ec                	mov    %ebp,%esp
  800139:	5d                   	pop    %ebp
  80013a:	c3                   	ret    

0080013b <sys_get_mac>:
...
sys_get_mac(uint8_t* macaddr){
  ...
  800144:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80014d:	b8 13 00 00 00       	mov    $0x13,%eax
  800152:	8b 55 08             	mov    0x8(%ebp),%edx
  800155:	89 cb                	mov    %ecx,%ebx
  800157:	89 cf                	mov    %ecx,%edi
  800159:	51                   	push   %ecx
  80015a:	52                   	push   %edx
  80015b:	53                   	push   %ebx
  80015c:	54                   	push   %esp
  ...
  800160:	54                   	push   %esp
  800161:	5d                   	pop    %ebp
  800162:	8d 35 6a 01 80 00    	lea    0x80016a,%esi
  800168:	0f 34                	sysenter 
  80016a:	5f                   	pop    %edi
  80016b:	5e                   	pop    %esi
  80016c:	5d                   	pop    %ebp
  80016d:	5c                   	pop    %esp
...
sys_get_mac(uint8_t* macaddr){
  ...
  800174:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800178:	89 ec                	mov    %ebp,%esp
  80017a:	5d                   	pop    %ebp
  80017b:	c3                   	ret    

0080017c <sys_receive_packet>:
...
sys_receive_packet(uint32_t addr,int* len){
  ...
  800185:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80018e:	b8 12 00 00 00       	mov    $0x12,%eax
...
sys_receive_packet(uint32_t addr,int* len){
  ...
  8001b6:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8001ba:	89 ec                	mov    %ebp,%esp
  8001bc:	5d                   	pop    %ebp
  8001bd:	c3                   	ret    

008001be <sys_transmit_packet>:
...
sys_transmit_packet(uint32_t addr,int len){
  ...
  8001c7:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001d0:	b8 11 00 00 00       	mov    $0x11,%eax
  ...
  8001e4:	54                   	push   %esp
  8001e5:	5d                   	pop    %ebp
  8001e6:	8d 35 ee 01 80 00    	lea    0x8001ee,%esi
  8001ec:	0f 34                	sysenter 
  8001ee:	5f                   	pop    %edi
  8001ef:	5e                   	pop    %esi
  8001f0:	5d                   	pop    %ebp
  8001f1:	5c                   	pop    %esp
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  80020d:	b8 10 00 00 00       	mov    $0x10,%eax
  ...
  800225:	54                   	push   %esp
  800226:	5d                   	pop    %ebp
  800227:	8d 35 2f 02 80 00    	lea    0x80022f,%esi
...
sys_exec(void* vph, uint32_t phnum, uint32_t esp, uint32_t eip){
  ...
  800236:	8b 1c 24             	mov    (%esp),%ebx
  800239:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80023d:	89 ec                	mov    %ebp,%esp
  80023f:	5d                   	pop    %ebp
  800240:	c3                   	ret    

00800241 <sys_env_set_prior>:
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  800244:	83 ec 28             	sub    $0x28,%esp
  800247:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800252:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  800279:	7e 28                	jle    8002a3 <sys_env_set_prior+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80027b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80027f:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800286:	00 
  800287:	c7 44 24 08 4f 27 80 	movl   $0x80274f,0x8(%esp)
  80028e:	00 
  80028f:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800296:	00 
  800297:	c7 04 24 6c 27 80 00 	movl   $0x80276c,(%esp)
  80029e:	e8 d1 12 00 00       	call   801574 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002bf:	b8 15 00 00 00       	mov    $0x15,%eax
  8002c4:	89 d1                	mov    %edx,%ecx
  8002c6:	89 d3                	mov    %edx,%ebx
  ...
  8002d1:	54                   	push   %esp
  8002d2:	5d                   	pop    %ebp
  8002d3:	8d 35 db 02 80 00    	lea    0x8002db,%esi
  8002d9:	0f 34                	sysenter 
  8002db:	5f                   	pop    %edi
  8002dc:	5e                   	pop    %esi
  8002dd:	5d                   	pop    %ebp
  8002de:	5c                   	pop    %esp
...
sys_time_msec(void)
{
  ...
  8002e2:	8b 1c 24             	mov    (%esp),%ebx
  8002e5:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8002e9:	89 ec                	mov    %ebp,%esp
  8002eb:	5d                   	pop    %ebp
  8002ec:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002ff:	b8 14 00 00 00       	mov    $0x14,%eax
  ...
  800312:	54                   	push   %esp
  800313:	5d                   	pop    %ebp
  800314:	8d 35 1c 03 80 00    	lea    0x80031c,%esi
  80031a:	0f 34                	sysenter 
  80031c:	5f                   	pop    %edi
  80031d:	5e                   	pop    %esi
  80031e:	5d                   	pop    %ebp
  80031f:	5c                   	pop    %esp
...
sys_ipc_recv(void *dstva)
{
  ...
  800334:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80033f:	b8 0e 00 00 00       	mov    $0xe,%eax
  ...
  800352:	54                   	push   %esp
  800353:	5d                   	pop    %ebp
  800354:	8d 35 5c 03 80 00    	lea    0x80035c,%esi
  80035a:	0f 34                	sysenter 
  80035c:	5f                   	pop    %edi
  80035d:	5e                   	pop    %esi
  80035e:	5d                   	pop    %ebp
  80035f:	5c                   	pop    %esp
  ...
  800365:	7e 28                	jle    80038f <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800367:	89 44 24 10          	mov    %eax,0x10(%esp)
  80036b:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  800372:	00 
  800373:	c7 44 24 08 4f 27 80 	movl   $0x80274f,0x8(%esp)
  80037a:	00 
  80037b:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800382:	00 
  800383:	c7 04 24 6c 27 80 00 	movl   $0x80276c,(%esp)
  80038a:	e8 e5 11 00 00       	call   801574 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80038f:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800392:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800395:	89 ec                	mov    %ebp,%esp
  800397:	5d                   	pop    %ebp
  800398:	c3                   	ret    

00800399 <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003cf:	8b 1c 24             	mov    (%esp),%ebx
  8003d2:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8003d6:	89 ec                	mov    %ebp,%esp
  8003d8:	5d                   	pop    %ebp
  8003d9:	c3                   	ret    

008003da <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003e0:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800412:	7e 28                	jle    80043c <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800414:	89 44 24 10          	mov    %eax,0x10(%esp)
  800418:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  80041f:	00 
  800420:	c7 44 24 08 4f 27 80 	movl   $0x80274f,0x8(%esp)
  800427:	00 
  800428:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80042f:	00 
  800430:	c7 04 24 6c 27 80 00 	movl   $0x80276c,(%esp)
  800437:	e8 38 11 00 00       	call   801574 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80043c:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80043f:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800442:	89 ec                	mov    %ebp,%esp
  800444:	5d                   	pop    %ebp
  800445:	c3                   	ret    

00800446 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80044c:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80044f:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800457:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  80046b:	54                   	push   %esp
  80046c:	5d                   	pop    %ebp
  80046d:	8d 35 75 04 80 00    	lea    0x800475,%esi
  800473:	0f 34                	sysenter 
  800475:	5f                   	pop    %edi
  800476:	5e                   	pop    %esi
  800477:	5d                   	pop    %ebp
  800478:	5c                   	pop    %esp
  ...
  80047e:	7e 28                	jle    8004a8 <sys_env_set_trapframe+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800480:	89 44 24 10          	mov    %eax,0x10(%esp)
  800484:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80048b:	00 
  80048c:	c7 44 24 08 4f 27 80 	movl   $0x80274f,0x8(%esp)
  800493:	00 
  800494:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80049b:	00 
  80049c:	c7 04 24 6c 27 80 00 	movl   $0x80276c,(%esp)
  8004a3:	e8 cc 10 00 00       	call   801574 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8004a8:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8004ab:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004ae:	89 ec                	mov    %ebp,%esp
  8004b0:	5d                   	pop    %ebp
  8004b1:	c3                   	ret    

008004b2 <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8004b5:	83 ec 28             	sub    $0x28,%esp
  8004b8:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8004bb:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8004c3:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8004d7:	54                   	push   %esp
  8004d8:	5d                   	pop    %ebp
  8004d9:	8d 35 e1 04 80 00    	lea    0x8004e1,%esi
  8004df:	0f 34                	sysenter 
  8004e1:	5f                   	pop    %edi
  8004e2:	5e                   	pop    %esi
  8004e3:	5d                   	pop    %ebp
  8004e4:	5c                   	pop    %esp
  ...
  8004ea:	7e 28                	jle    800514 <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004ec:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004f0:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8004f7:	00 
  8004f8:	c7 44 24 08 4f 27 80 	movl   $0x80274f,0x8(%esp)
  8004ff:	00 
  800500:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800507:	00 
  800508:	c7 04 24 6c 27 80 00 	movl   $0x80276c,(%esp)
  80050f:	e8 60 10 00 00       	call   801574 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800514:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800517:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80051a:	89 ec                	mov    %ebp,%esp
  80051c:	5d                   	pop    %ebp
  80051d:	c3                   	ret    

0080051e <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800524:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800527:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80052f:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800543:	54                   	push   %esp
  800544:	5d                   	pop    %ebp
  800545:	8d 35 4d 05 80 00    	lea    0x80054d,%esi
  80054b:	0f 34                	sysenter 
  80054d:	5f                   	pop    %edi
  80054e:	5e                   	pop    %esi
  80054f:	5d                   	pop    %ebp
  800550:	5c                   	pop    %esp
  ...
  800556:	7e 28                	jle    800580 <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800558:	89 44 24 10          	mov    %eax,0x10(%esp)
  80055c:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  800563:	00 
  800564:	c7 44 24 08 4f 27 80 	movl   $0x80274f,0x8(%esp)
  80056b:	00 
  80056c:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800573:	00 
  800574:	c7 04 24 6c 27 80 00 	movl   $0x80276c,(%esp)
  80057b:	e8 f4 0f 00 00       	call   801574 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80058d:	83 ec 28             	sub    $0x28,%esp
  800590:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800593:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800596:	8b 7d 18             	mov    0x18(%ebp),%edi
  800599:	0b 7d 14             	or     0x14(%ebp),%edi
  80059c:	b8 06 00 00 00       	mov    $0x6,%eax
  8005a1:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8005a4:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8005a7:	8b 55 08             	mov    0x8(%ebp),%edx
  8005aa:	51                   	push   %ecx
  8005ab:	52                   	push   %edx
  8005ac:	53                   	push   %ebx
  8005ad:	54                   	push   %esp
  ...
  8005b1:	54                   	push   %esp
  8005b2:	5d                   	pop    %ebp
  8005b3:	8d 35 bb 05 80 00    	lea    0x8005bb,%esi
  8005b9:	0f 34                	sysenter 
  8005bb:	5f                   	pop    %edi
  8005bc:	5e                   	pop    %esi
  8005bd:	5d                   	pop    %ebp
  8005be:	5c                   	pop    %esp
  ...
  8005c4:	7e 28                	jle    8005ee <sys_page_map+0x64>
		panic("syscall %d returned %d (> 0)", num, ret);
  8005c6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8005ca:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  8005d1:	00 
  8005d2:	c7 44 24 08 4f 27 80 	movl   $0x80274f,0x8(%esp)
  8005d9:	00 
  8005da:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8005e1:	00 
  8005e2:	c7 04 24 6c 27 80 00 	movl   $0x80276c,(%esp)
  8005e9:	e8 86 0f 00 00       	call   801574 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8005ee:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8005f1:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8005f4:	89 ec                	mov    %ebp,%esp
  8005f6:	5d                   	pop    %ebp
  8005f7:	c3                   	ret    

008005f8 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8005fe:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800601:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800609:	b8 05 00 00 00       	mov    $0x5,%eax
  80060e:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  80061e:	54                   	push   %esp
  80061f:	5d                   	pop    %ebp
  800620:	8d 35 28 06 80 00    	lea    0x800628,%esi
  800626:	0f 34                	sysenter 
  800628:	5f                   	pop    %edi
  800629:	5e                   	pop    %esi
  80062a:	5d                   	pop    %ebp
  80062b:	5c                   	pop    %esp
  ...
  800631:	7e 28                	jle    80065b <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  800633:	89 44 24 10          	mov    %eax,0x10(%esp)
  800637:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  80063e:	00 
  80063f:	c7 44 24 08 4f 27 80 	movl   $0x80274f,0x8(%esp)
  800646:	00 
  800647:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80064e:	00 
  80064f:	c7 04 24 6c 27 80 00 	movl   $0x80276c,(%esp)
  800656:	e8 19 0f 00 00       	call   801574 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80065b:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80065e:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800677:	b8 0c 00 00 00       	mov    $0xc,%eax
...
sys_yield(void)
{
  ...
  80069a:	8b 1c 24             	mov    (%esp),%ebx
  80069d:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8006a1:	89 ec                	mov    %ebp,%esp
  8006a3:	5d                   	pop    %ebp
  8006a4:	c3                   	ret    

008006a5 <sys_map_kernel_page>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8006b7:	b8 04 00 00 00       	mov    $0x4,%eax
  ...
  8006cb:	54                   	push   %esp
  8006cc:	5d                   	pop    %ebp
  8006cd:	8d 35 d5 06 80 00    	lea    0x8006d5,%esi
  8006d3:	0f 34                	sysenter 
  8006d5:	5f                   	pop    %edi
  8006d6:	5e                   	pop    %esi
  8006d7:	5d                   	pop    %ebp
  8006d8:	5c                   	pop    %esp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  8006dc:	8b 1c 24             	mov    (%esp),%ebx
  8006df:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8006e3:	89 ec                	mov    %ebp,%esp
  8006e5:	5d                   	pop    %ebp
  8006e6:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8006f9:	b8 02 00 00 00       	mov    $0x2,%eax
  8006fe:	89 d1                	mov    %edx,%ecx
  800700:	89 d3                	mov    %edx,%ebx
  800702:	89 d7                	mov    %edx,%edi
  800704:	51                   	push   %ecx
  800705:	52                   	push   %edx
  800706:	53                   	push   %ebx
  800707:	54                   	push   %esp
  ...
  80070b:	54                   	push   %esp
  80070c:	5d                   	pop    %ebp
  80070d:	8d 35 15 07 80 00    	lea    0x800715,%esi
  800713:	0f 34                	sysenter 
  800715:	5f                   	pop    %edi
  800716:	5e                   	pop    %esi
  800717:	5d                   	pop    %ebp
  800718:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  80071c:	8b 1c 24             	mov    (%esp),%ebx
  80071f:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800723:	89 ec                	mov    %ebp,%esp
  800725:	5d                   	pop    %ebp
  800726:	c3                   	ret    

00800727 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  80072a:	83 ec 28             	sub    $0x28,%esp
  80072d:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800730:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800738:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  80074b:	54                   	push   %esp
  80074c:	5d                   	pop    %ebp
  80074d:	8d 35 55 07 80 00    	lea    0x800755,%esi
  800753:	0f 34                	sysenter 
  800755:	5f                   	pop    %edi
  800756:	5e                   	pop    %esi
  800757:	5d                   	pop    %ebp
  800758:	5c                   	pop    %esp
  ...
  80075e:	7e 28                	jle    800788 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800760:	89 44 24 10          	mov    %eax,0x10(%esp)
  800764:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80076b:	00 
  80076c:	c7 44 24 08 4f 27 80 	movl   $0x80274f,0x8(%esp)
  800773:	00 
  800774:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80077b:	00 
  80077c:	c7 04 24 6c 27 80 00 	movl   $0x80276c,(%esp)
  800783:	e8 ec 0d 00 00       	call   801574 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800788:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80078b:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80078e:	89 ec                	mov    %ebp,%esp
  800790:	5d                   	pop    %ebp
  800791:	c3                   	ret    
	...
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  8008c9:	be f8 27 80 00       	mov    $0x8027f8,%esi
		if (devtab[i]->dev_id == dev_id) {
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8008fc:	c7 04 24 7c 27 80 00 	movl   $0x80277c,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009e1:	c7 04 24 9c 27 80 00 	movl   $0x80279c,(%esp)
  ...
  800a41:	e8 6b fe ff ff       	call   8008b1 <dev_lookup>
{
  ...
  800a63:	c7 04 24 bd 27 80 00 	movl   $0x8027bd,(%esp)
  ...
  800aca:	e8 e2 fd ff ff       	call   8008b1 <dev_lookup>
{
  ...
  800af1:	c7 04 24 da 27 80 00 	movl   $0x8027da,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800bf0:	e8 29 f9 ff ff       	call   80051e <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800d3e:	e8 47 f8 ff ff       	call   80058a <sys_page_map>
  ...
  800d79:	e8 0c f8 ff ff       	call   80058a <sys_page_map>
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801076:	c7 44 24 04 04 28 80 	movl   $0x802804,0x4(%esp)
  80107d:	00 
...
alloc_sockfd(int sockid)
{
  ...
  801148:	e8 ab f4 ff ff       	call   8005f8 <sys_page_alloc>
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8013c8:	c7 44 24 0c 10 28 80 	movl   $0x802810,0xc(%esp)
  8013cf:	00 
  8013d0:	c7 44 24 08 1c 28 80 	movl   $0x80281c,0x8(%esp)
  8013d7:	00 
  8013d8:	c7 44 24 04 6c 00 00 	movl   $0x6c,0x4(%esp)
  8013df:	00 
  8013e0:	c7 04 24 31 28 80 00 	movl   $0x802831,(%esp)
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  80145d:	c7 44 24 0c 3d 28 80 	movl   $0x80283d,0xc(%esp)
  801464:	00 
  801465:	c7 44 24 08 1c 28 80 	movl   $0x80281c,0x8(%esp)
  80146c:	00 
  80146d:	c7 44 24 04 61 00 00 	movl   $0x61,0x4(%esp)
  801474:	00 
  801475:	c7 04 24 31 28 80 00 	movl   $0x802831,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  801585:	e8 5d f1 ff ff       	call   8006e7 <sys_getenvid>
  ...
  8015a0:	c7 04 24 54 28 80 00 	movl   $0x802854,(%esp)
  ...
  8015b6:	e8 11 00 00 00       	call   8015cc <vcprintf>
	cprintf("\n");
  8015bb:	c7 04 24 f4 27 80 00 	movl   $0x8027f4,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801620:	e8 d7 ea ff ff       	call   8000fc <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  801674:	e8 83 ea ff ff       	call   8000fc <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801770:	0f be 80 77 28 80 00 	movsbl 0x802877(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801926:	c7 44 24 08 88 28 80 	movl   $0x802888,0x8(%esp)
  80192d:	00 
  ...
  80194c:	c7 44 24 08 2e 28 80 	movl   $0x80282e,0x8(%esp)
  801953:	00 
  ...
  80198a:	be 91 28 80 00       	mov    $0x802891,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801c89:	0f be 80 77 28 80 00 	movsbl 0x802877(%eax),%eax
  ...
  801d35:	c7 44 24 0c ac 29 80 	movl   $0x8029ac,0xc(%esp)
  801d3c:	00 
  801d3d:	c7 44 24 08 2e 28 80 	movl   $0x80282e,0x8(%esp)
  801d44:	00 
  ...
  801d6b:	c7 44 24 0c e4 29 80 	movl   $0x8029e4,0xc(%esp)
  801d72:	00 
  801d73:	c7 44 24 08 2e 28 80 	movl   $0x80282e,0x8(%esp)
  801d7a:	00 
  ...
  801e08:	0f be 80 77 28 80 00 	movsbl 0x802877(%eax),%eax
  ...
  801e4a:	0f be 80 77 28 80 00 	movsbl 0x802877(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8023c3:	e8 d1 df ff ff       	call   800399 <sys_ipc_try_send>
  ...
  8023e0:	e8 b4 df ff ff       	call   800399 <sys_ipc_try_send>
           if(ret == 0)
  ...
  802405:	e8 6a f1 ff ff       	call   801574 <_panic>
           sys_yield();
  80240a:	e8 56 e2 ff ff       	call   800665 <sys_yield>
        }
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802435:	e8 f4 de ff ff       	call   80032e <sys_ipc_recv>
  80243a:	eb 08                	jmp    802444 <ipc_recv+0x2b>
        else
           ret = sys_ipc_recv(pg);
  80243c:	89 04 24             	mov    %eax,(%esp)
  80243f:	e8 ea de ff ff       	call   80032e <sys_ipc_recv>
        if(ret == 0){
