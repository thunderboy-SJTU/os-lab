...
libmain(int argc, char **argv)
{
  ...
  80004e:	e8 84 06 00 00       	call   8006d7 <sys_getenvid>
...
exit(void)
{
  ...
  800093:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800096:	e8 d0 0b 00 00       	call   800c6b <close_all>
	sys_env_destroy(0);
  80009b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a2:	e8 70 06 00 00       	call   800717 <sys_env_destroy>
}
  8000a7:	c9                   	leave  
  8000a8:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80013d:	b8 13 00 00 00       	mov    $0x13,%eax
...
sys_receive_packet(uint32_t addr,int* len){
  ...
  800172:	89 1c 24             	mov    %ebx,(%esp)
  800175:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
sys_receive_packet(uint32_t addr,int* len){
  ...
  8001a3:	8b 1c 24             	mov    (%esp),%ebx
  8001a6:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8001aa:	89 ec                	mov    %ebp,%esp
  8001ac:	5d                   	pop    %ebp
  8001ad:	c3                   	ret    

008001ae <sys_transmit_packet>:
...
sys_transmit_packet(uint32_t addr,int len){
  ...
  8001b7:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001c0:	b8 11 00 00 00       	mov    $0x11,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8001fd:	b8 10 00 00 00       	mov    $0x10,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800242:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  800269:	7e 28                	jle    800293 <sys_env_set_prior+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80026b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80026f:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  800276:	00 
  800277:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  80027e:	00 
  80027f:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800286:	00 
  800287:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  80028e:	e8 d1 12 00 00       	call   801564 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002af:	b8 15 00 00 00       	mov    $0x15,%eax
  8002b4:	89 d1                	mov    %edx,%ecx
  8002b6:	89 d3                	mov    %edx,%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002ef:	b8 14 00 00 00       	mov    $0x14,%eax
  8002f4:	8b 55 08             	mov    0x8(%ebp),%edx
  8002f7:	89 cb                	mov    %ecx,%ebx
  8002f9:	89 cf                	mov    %ecx,%edi
  8002fb:	51                   	push   %ecx
  8002fc:	52                   	push   %edx
  8002fd:	53                   	push   %ebx
  8002fe:	54                   	push   %esp
...
sys_sbrk(uint32_t inc)
{
  ...
  800313:	8b 1c 24             	mov    (%esp),%ebx
  800316:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80031a:	89 ec                	mov    %ebp,%esp
  80031c:	5d                   	pop    %ebp
  80031d:	c3                   	ret    

0080031e <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  800324:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80032f:	b8 0e 00 00 00       	mov    $0xe,%eax
  800334:	8b 55 08             	mov    0x8(%ebp),%edx
  800337:	89 cb                	mov    %ecx,%ebx
  800339:	89 cf                	mov    %ecx,%edi
  80033b:	51                   	push   %ecx
  80033c:	52                   	push   %edx
  80033d:	53                   	push   %ebx
  80033e:	54                   	push   %esp
  ...
  800355:	7e 28                	jle    80037f <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800357:	89 44 24 10          	mov    %eax,0x10(%esp)
  80035b:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  800362:	00 
  800363:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  80036a:	00 
  80036b:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800372:	00 
  800373:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  80037a:	e8 e5 11 00 00       	call   801564 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80037f:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800382:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800385:	89 ec                	mov    %ebp,%esp
  800387:	5d                   	pop    %ebp
  800388:	c3                   	ret    

00800389 <sys_ipc_try_send>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80039b:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003bf:	8b 1c 24             	mov    (%esp),%ebx
  8003c2:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8003c6:	89 ec                	mov    %ebp,%esp
  8003c8:	5d                   	pop    %ebp
  8003c9:	c3                   	ret    

008003ca <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003d0:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800402:	7e 28                	jle    80042c <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800404:	89 44 24 10          	mov    %eax,0x10(%esp)
  800408:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  80040f:	00 
  800410:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  800417:	00 
  800418:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80041f:	00 
  800420:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  800427:	e8 38 11 00 00       	call   801564 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80042c:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80042f:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800432:	89 ec                	mov    %ebp,%esp
  800434:	5d                   	pop    %ebp
  800435:	c3                   	ret    

00800436 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800439:	83 ec 28             	sub    $0x28,%esp
  80043c:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80043f:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800447:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  80045b:	54                   	push   %esp
  80045c:	5d                   	pop    %ebp
  80045d:	8d 35 65 04 80 00    	lea    0x800465,%esi
  800463:	0f 34                	sysenter 
  800465:	5f                   	pop    %edi
  800466:	5e                   	pop    %esi
  800467:	5d                   	pop    %ebp
  800468:	5c                   	pop    %esp
  ...
  80046e:	7e 28                	jle    800498 <sys_env_set_trapframe+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800470:	89 44 24 10          	mov    %eax,0x10(%esp)
  800474:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80047b:	00 
  80047c:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  800483:	00 
  800484:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80048b:	00 
  80048c:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  800493:	e8 cc 10 00 00       	call   801564 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800498:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80049b:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80049e:	89 ec                	mov    %ebp,%esp
  8004a0:	5d                   	pop    %ebp
  8004a1:	c3                   	ret    

008004a2 <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8004a8:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8004ab:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8004b3:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8004c7:	54                   	push   %esp
  8004c8:	5d                   	pop    %ebp
  8004c9:	8d 35 d1 04 80 00    	lea    0x8004d1,%esi
  8004cf:	0f 34                	sysenter 
  8004d1:	5f                   	pop    %edi
  8004d2:	5e                   	pop    %esi
  8004d3:	5d                   	pop    %ebp
  8004d4:	5c                   	pop    %esp
  ...
  8004da:	7e 28                	jle    800504 <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004dc:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004e0:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8004e7:	00 
  8004e8:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  8004ef:	00 
  8004f0:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8004f7:	00 
  8004f8:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  8004ff:	e8 60 10 00 00       	call   801564 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800504:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800507:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80050a:	89 ec                	mov    %ebp,%esp
  80050c:	5d                   	pop    %ebp
  80050d:	c3                   	ret    

0080050e <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800514:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800517:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80051f:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800533:	54                   	push   %esp
  800534:	5d                   	pop    %ebp
  800535:	8d 35 3d 05 80 00    	lea    0x80053d,%esi
  80053b:	0f 34                	sysenter 
  80053d:	5f                   	pop    %edi
  80053e:	5e                   	pop    %esi
  80053f:	5d                   	pop    %ebp
  800540:	5c                   	pop    %esp
  ...
  800546:	7e 28                	jle    800570 <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800548:	89 44 24 10          	mov    %eax,0x10(%esp)
  80054c:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  800553:	00 
  800554:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  80055b:	00 
  80055c:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800563:	00 
  800564:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  80056b:	e8 f4 0f 00 00       	call   801564 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800570:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800573:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800576:	89 ec                	mov    %ebp,%esp
  800578:	5d                   	pop    %ebp
  800579:	c3                   	ret    

0080057a <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800580:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800583:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800586:	8b 7d 18             	mov    0x18(%ebp),%edi
  800589:	0b 7d 14             	or     0x14(%ebp),%edi
  80058c:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  8005b4:	7e 28                	jle    8005de <sys_page_map+0x64>
		panic("syscall %d returned %d (> 0)", num, ret);
  8005b6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8005ba:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  8005c1:	00 
  8005c2:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  8005c9:	00 
  8005ca:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8005d1:	00 
  8005d2:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  8005d9:	e8 86 0f 00 00       	call   801564 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8005f1:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8005f4:	bf 00 00 00 00       	mov    $0x0,%edi
  8005f9:	b8 05 00 00 00       	mov    $0x5,%eax
  8005fe:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800601:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  800621:	7e 28                	jle    80064b <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  800623:	89 44 24 10          	mov    %eax,0x10(%esp)
  800627:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  80062e:	00 
  80062f:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  800636:	00 
  800637:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80063e:	00 
  80063f:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  800646:	e8 19 0f 00 00       	call   801564 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80064b:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80064e:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800651:	89 ec                	mov    %ebp,%esp
  800653:	5d                   	pop    %ebp
  800654:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800667:	b8 0c 00 00 00       	mov    $0xc,%eax
  80066c:	89 d1                	mov    %edx,%ecx
  80066e:	89 d3                	mov    %edx,%ebx
  ...
  800679:	54                   	push   %esp
  80067a:	5d                   	pop    %ebp
  80067b:	8d 35 83 06 80 00    	lea    0x800683,%esi
  800681:	0f 34                	sysenter 
  800683:	5f                   	pop    %edi
  800684:	5e                   	pop    %esi
  800685:	5d                   	pop    %ebp
  800686:	5c                   	pop    %esp
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8006bb:	54                   	push   %esp
  8006bc:	5d                   	pop    %ebp
  8006bd:	8d 35 c5 06 80 00    	lea    0x8006c5,%esi
  8006c3:	0f 34                	sysenter 
  8006c5:	5f                   	pop    %edi
  8006c6:	5e                   	pop    %esi
  8006c7:	5d                   	pop    %ebp
  8006c8:	5c                   	pop    %esp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  8006cc:	8b 1c 24             	mov    (%esp),%ebx
  8006cf:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8006d3:	89 ec                	mov    %ebp,%esp
  8006d5:	5d                   	pop    %ebp
  8006d6:	c3                   	ret    

008006d7 <sys_getenvid>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8006e9:	b8 02 00 00 00       	mov    $0x2,%eax
  ...
  8006fb:	54                   	push   %esp
  8006fc:	5d                   	pop    %ebp
  8006fd:	8d 35 05 07 80 00    	lea    0x800705,%esi
  800703:	0f 34                	sysenter 
  800705:	5f                   	pop    %edi
  800706:	5e                   	pop    %esi
  800707:	5d                   	pop    %ebp
  800708:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  80070c:	8b 1c 24             	mov    (%esp),%ebx
  80070f:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800713:	89 ec                	mov    %ebp,%esp
  800715:	5d                   	pop    %ebp
  800716:	c3                   	ret    

00800717 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  80071d:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800720:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800728:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  80073b:	54                   	push   %esp
  80073c:	5d                   	pop    %ebp
  80073d:	8d 35 45 07 80 00    	lea    0x800745,%esi
  800743:	0f 34                	sysenter 
  800745:	5f                   	pop    %edi
  800746:	5e                   	pop    %esi
  800747:	5d                   	pop    %ebp
  800748:	5c                   	pop    %esp
  ...
  80074e:	7e 28                	jle    800778 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800750:	89 44 24 10          	mov    %eax,0x10(%esp)
  800754:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80075b:	00 
  80075c:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  800763:	00 
  800764:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80076b:	00 
  80076c:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  800773:	e8 ec 0d 00 00       	call   801564 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800778:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80077b:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80077e:	89 ec                	mov    %ebp,%esp
  800780:	5d                   	pop    %ebp
  800781:	c3                   	ret    
	...
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800be0:	e8 29 f9 ff ff       	call   80050e <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800d2e:	e8 47 f8 ff ff       	call   80057a <sys_page_map>
  ...
  800d69:	e8 0c f8 ff ff       	call   80057a <sys_page_map>
...
alloc_sockfd(int sockid)
{
  ...
  801138:	e8 ab f4 ff ff       	call   8005e8 <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  801575:	e8 5d f1 ff ff       	call   8006d7 <sys_getenvid>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801610:	e8 d7 ea ff ff       	call   8000ec <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  801664:	e8 83 ea ff ff       	call   8000ec <sys_cputs>
		b->idx = 0;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8023b3:	e8 d1 df ff ff       	call   800389 <sys_ipc_try_send>
  ...
  8023d0:	e8 b4 df ff ff       	call   800389 <sys_ipc_try_send>
           if(ret == 0)
  ...
  8023f5:	e8 6a f1 ff ff       	call   801564 <_panic>
           sys_yield();
  8023fa:	e8 56 e2 ff ff       	call   800655 <sys_yield>
        }
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802425:	e8 f4 de ff ff       	call   80031e <sys_ipc_recv>
  80242a:	eb 08                	jmp    802434 <ipc_recv+0x2b>
        else
           ret = sys_ipc_recv(pg);
  80242c:	89 04 24             	mov    %eax,(%esp)
  80242f:	e8 ea de ff ff       	call   80031e <sys_ipc_recv>
        if(ret == 0){
