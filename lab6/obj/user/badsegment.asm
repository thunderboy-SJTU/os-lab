...
libmain(int argc, char **argv)
{
  ...
  800052:	e8 84 06 00 00       	call   8006db <sys_getenvid>
  800057:	25 ff 03 00 00       	and    $0x3ff,%eax
  80005c:	89 c2                	mov    %eax,%edx
  80005e:	c1 e2 07             	shl    $0x7,%edx
  800061:	8d 84 82 00 00 c0 ee 	lea    -0x11400000(%edx,%eax,4),%eax
...
exit(void)
{
  ...
  800097:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009a:	e8 cc 0b 00 00       	call   800c6b <close_all>
	sys_env_destroy(0);
  80009f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a6:	e8 70 06 00 00       	call   80071b <sys_env_destroy>
}
  8000ab:	c9                   	leave  
  8000ac:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800141:	b8 13 00 00 00       	mov    $0x13,%eax
...
sys_receive_packet(uint32_t addr,int* len){
  ...
  800176:	89 1c 24             	mov    %ebx,(%esp)
  800179:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
sys_receive_packet(uint32_t addr,int* len){
  ...
  8001a7:	8b 1c 24             	mov    (%esp),%ebx
  8001aa:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8001ae:	89 ec                	mov    %ebp,%esp
  8001b0:	5d                   	pop    %ebp
  8001b1:	c3                   	ret    

008001b2 <sys_transmit_packet>:
...
sys_transmit_packet(uint32_t addr,int len){
  ...
  8001b8:	89 1c 24             	mov    %ebx,(%esp)
  8001bb:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800201:	b8 10 00 00 00       	mov    $0x10,%eax
  ...
  800219:	54                   	push   %esp
  80021a:	5d                   	pop    %ebp
  80021b:	8d 35 23 02 80 00    	lea    0x800223,%esi
  800221:	0f 34                	sysenter 
  800223:	5f                   	pop    %edi
  800224:	5e                   	pop    %esi
  800225:	5d                   	pop    %ebp
  800226:	5c                   	pop    %esp
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  800238:	83 ec 28             	sub    $0x28,%esp
  80023b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80023e:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800246:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  80025a:	54                   	push   %esp
  80025b:	5d                   	pop    %ebp
  80025c:	8d 35 64 02 80 00    	lea    0x800264,%esi
  800262:	0f 34                	sysenter 
  800264:	5f                   	pop    %edi
  800265:	5e                   	pop    %esi
  800266:	5d                   	pop    %ebp
  800267:	5c                   	pop    %esp
  ...
  80026d:	7e 28                	jle    800297 <sys_env_set_prior+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80026f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800273:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  80027a:	00 
  80027b:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  800282:	00 
  800283:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80028a:	00 
  80028b:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  800292:	e8 cd 12 00 00       	call   801564 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002b3:	b8 15 00 00 00       	mov    $0x15,%eax
  8002b8:	89 d1                	mov    %edx,%ecx
  8002ba:	89 d3                	mov    %edx,%ebx
...
sys_time_msec(void)
{
  ...
  8002d6:	8b 1c 24             	mov    (%esp),%ebx
  8002d9:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8002dd:	89 ec                	mov    %ebp,%esp
  8002df:	5d                   	pop    %ebp
  8002e0:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002f3:	b8 14 00 00 00       	mov    $0x14,%eax
  8002f8:	8b 55 08             	mov    0x8(%ebp),%edx
  8002fb:	89 cb                	mov    %ecx,%ebx
  8002fd:	89 cf                	mov    %ecx,%edi
  8002ff:	51                   	push   %ecx
  800300:	52                   	push   %edx
  800301:	53                   	push   %ebx
  800302:	54                   	push   %esp
  ...
  800306:	54                   	push   %esp
  800307:	5d                   	pop    %ebp
  800308:	8d 35 10 03 80 00    	lea    0x800310,%esi
  80030e:	0f 34                	sysenter 
  800310:	5f                   	pop    %edi
  800311:	5e                   	pop    %esi
  800312:	5d                   	pop    %ebp
  800313:	5c                   	pop    %esp
...
sys_sbrk(uint32_t inc)
{
  ...
  800317:	8b 1c 24             	mov    (%esp),%ebx
  80031a:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80031e:	89 ec                	mov    %ebp,%esp
  800320:	5d                   	pop    %ebp
  800321:	c3                   	ret    
...
sys_ipc_recv(void *dstva)
{
  ...
  800328:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800346:	54                   	push   %esp
  800347:	5d                   	pop    %ebp
  800348:	8d 35 50 03 80 00    	lea    0x800350,%esi
  80034e:	0f 34                	sysenter 
  800350:	5f                   	pop    %edi
  800351:	5e                   	pop    %esi
  800352:	5d                   	pop    %ebp
  800353:	5c                   	pop    %esp
  ...
  800359:	7e 28                	jle    800383 <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  80035b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80035f:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  800366:	00 
  800367:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  80036e:	00 
  80036f:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800376:	00 
  800377:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  80037e:	e8 e1 11 00 00       	call   801564 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800383:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800386:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800389:	89 ec                	mov    %ebp,%esp
  80038b:	5d                   	pop    %ebp
  80038c:	c3                   	ret    

0080038d <sys_ipc_try_send>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80039f:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003c3:	8b 1c 24             	mov    (%esp),%ebx
  8003c6:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8003ca:	89 ec                	mov    %ebp,%esp
  8003cc:	5d                   	pop    %ebp
  8003cd:	c3                   	ret    

008003ce <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003d1:	83 ec 28             	sub    $0x28,%esp
  8003d4:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8003f3:	54                   	push   %esp
  8003f4:	5d                   	pop    %ebp
  8003f5:	8d 35 fd 03 80 00    	lea    0x8003fd,%esi
  8003fb:	0f 34                	sysenter 
  8003fd:	5f                   	pop    %edi
  8003fe:	5e                   	pop    %esi
  8003ff:	5d                   	pop    %ebp
  800400:	5c                   	pop    %esp
  ...
  800406:	7e 28                	jle    800430 <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800408:	89 44 24 10          	mov    %eax,0x10(%esp)
  80040c:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  800413:	00 
  800414:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  80041b:	00 
  80041c:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800423:	00 
  800424:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  80042b:	e8 34 11 00 00       	call   801564 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800430:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800433:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800436:	89 ec                	mov    %ebp,%esp
  800438:	5d                   	pop    %ebp
  800439:	c3                   	ret    

0080043a <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80043d:	83 ec 28             	sub    $0x28,%esp
  800440:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800443:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80045f:	54                   	push   %esp
  800460:	5d                   	pop    %ebp
  800461:	8d 35 69 04 80 00    	lea    0x800469,%esi
  800467:	0f 34                	sysenter 
  800469:	5f                   	pop    %edi
  80046a:	5e                   	pop    %esi
  80046b:	5d                   	pop    %ebp
  80046c:	5c                   	pop    %esp
  ...
  800472:	7e 28                	jle    80049c <sys_env_set_trapframe+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800474:	89 44 24 10          	mov    %eax,0x10(%esp)
  800478:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80047f:	00 
  800480:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  800487:	00 
  800488:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80048f:	00 
  800490:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  800497:	e8 c8 10 00 00       	call   801564 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80049c:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80049f:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004a2:	89 ec                	mov    %ebp,%esp
  8004a4:	5d                   	pop    %ebp
  8004a5:	c3                   	ret    

008004a6 <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8004ac:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8004af:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8004b7:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8004cb:	54                   	push   %esp
  8004cc:	5d                   	pop    %ebp
  8004cd:	8d 35 d5 04 80 00    	lea    0x8004d5,%esi
  8004d3:	0f 34                	sysenter 
  8004d5:	5f                   	pop    %edi
  8004d6:	5e                   	pop    %esi
  8004d7:	5d                   	pop    %ebp
  8004d8:	5c                   	pop    %esp
  ...
  8004de:	7e 28                	jle    800508 <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004e0:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004e4:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8004eb:	00 
  8004ec:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  8004f3:	00 
  8004f4:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8004fb:	00 
  8004fc:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  800503:	e8 5c 10 00 00       	call   801564 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800508:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80050b:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80050e:	89 ec                	mov    %ebp,%esp
  800510:	5d                   	pop    %ebp
  800511:	c3                   	ret    

00800512 <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800515:	83 ec 28             	sub    $0x28,%esp
  800518:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80051b:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800523:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800537:	54                   	push   %esp
  800538:	5d                   	pop    %ebp
  800539:	8d 35 41 05 80 00    	lea    0x800541,%esi
  80053f:	0f 34                	sysenter 
  800541:	5f                   	pop    %edi
  800542:	5e                   	pop    %esi
  800543:	5d                   	pop    %ebp
  800544:	5c                   	pop    %esp
  ...
  80054a:	7e 28                	jle    800574 <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80054c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800550:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  800557:	00 
  800558:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  80055f:	00 
  800560:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800567:	00 
  800568:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  80056f:	e8 f0 0f 00 00       	call   801564 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800574:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800577:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80057a:	89 ec                	mov    %ebp,%esp
  80057c:	5d                   	pop    %ebp
  80057d:	c3                   	ret    

0080057e <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800584:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800587:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  80058a:	8b 7d 18             	mov    0x18(%ebp),%edi
  80058d:	0b 7d 14             	or     0x14(%ebp),%edi
  800590:	b8 06 00 00 00       	mov    $0x6,%eax
  800595:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800598:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  8005a5:	54                   	push   %esp
  8005a6:	5d                   	pop    %ebp
  8005a7:	8d 35 af 05 80 00    	lea    0x8005af,%esi
  8005ad:	0f 34                	sysenter 
  8005af:	5f                   	pop    %edi
  8005b0:	5e                   	pop    %esi
  8005b1:	5d                   	pop    %ebp
  8005b2:	5c                   	pop    %esp
  ...
  8005b8:	7e 28                	jle    8005e2 <sys_page_map+0x64>
		panic("syscall %d returned %d (> 0)", num, ret);
  8005ba:	89 44 24 10          	mov    %eax,0x10(%esp)
  8005be:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  8005c5:	00 
  8005c6:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  8005cd:	00 
  8005ce:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8005d5:	00 
  8005d6:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  8005dd:	e8 82 0f 00 00       	call   801564 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8005e2:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8005e5:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8005e8:	89 ec                	mov    %ebp,%esp
  8005ea:	5d                   	pop    %ebp
  8005eb:	c3                   	ret    

008005ec <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8005ef:	83 ec 28             	sub    $0x28,%esp
  8005f2:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8005f5:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8005fd:	b8 05 00 00 00       	mov    $0x5,%eax
  800602:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  800625:	7e 28                	jle    80064f <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  800627:	89 44 24 10          	mov    %eax,0x10(%esp)
  80062b:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800632:	00 
  800633:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  80063a:	00 
  80063b:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800642:	00 
  800643:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  80064a:	e8 15 0f 00 00       	call   801564 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80066b:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  80067d:	54                   	push   %esp
  80067e:	5d                   	pop    %ebp
  80067f:	8d 35 87 06 80 00    	lea    0x800687,%esi
  800685:	0f 34                	sysenter 
  800687:	5f                   	pop    %edi
  800688:	5e                   	pop    %esi
  800689:	5d                   	pop    %ebp
  80068a:	5c                   	pop    %esp
...
sys_yield(void)
{
  ...
  80068e:	8b 1c 24             	mov    (%esp),%ebx
  800691:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800695:	89 ec                	mov    %ebp,%esp
  800697:	5d                   	pop    %ebp
  800698:	c3                   	ret    

00800699 <sys_map_kernel_page>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8006ab:	b8 04 00 00 00       	mov    $0x4,%eax
  ...
  8006bf:	54                   	push   %esp
  8006c0:	5d                   	pop    %ebp
  8006c1:	8d 35 c9 06 80 00    	lea    0x8006c9,%esi
  8006c7:	0f 34                	sysenter 
  8006c9:	5f                   	pop    %edi
  8006ca:	5e                   	pop    %esi
  8006cb:	5d                   	pop    %ebp
  8006cc:	5c                   	pop    %esp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  8006d0:	8b 1c 24             	mov    (%esp),%ebx
  8006d3:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8006d7:	89 ec                	mov    %ebp,%esp
  8006d9:	5d                   	pop    %ebp
  8006da:	c3                   	ret    

008006db <sys_getenvid>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8006ff:	54                   	push   %esp
  800700:	5d                   	pop    %ebp
  800701:	8d 35 09 07 80 00    	lea    0x800709,%esi
  800707:	0f 34                	sysenter 
  800709:	5f                   	pop    %edi
  80070a:	5e                   	pop    %esi
  80070b:	5d                   	pop    %ebp
  80070c:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  800710:	8b 1c 24             	mov    (%esp),%ebx
  800713:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800717:	89 ec                	mov    %ebp,%esp
  800719:	5d                   	pop    %ebp
  80071a:	c3                   	ret    

0080071b <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  800721:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800724:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80072c:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  80073f:	54                   	push   %esp
  800740:	5d                   	pop    %ebp
  800741:	8d 35 49 07 80 00    	lea    0x800749,%esi
  800747:	0f 34                	sysenter 
  800749:	5f                   	pop    %edi
  80074a:	5e                   	pop    %esi
  80074b:	5d                   	pop    %ebp
  80074c:	5c                   	pop    %esp
  ...
  800752:	7e 28                	jle    80077c <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800754:	89 44 24 10          	mov    %eax,0x10(%esp)
  800758:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80075f:	00 
  800760:	c7 44 24 08 4a 27 80 	movl   $0x80274a,0x8(%esp)
  800767:	00 
  800768:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80076f:	00 
  800770:	c7 04 24 67 27 80 00 	movl   $0x802767,(%esp)
  800777:	e8 e8 0d 00 00       	call   801564 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  80077c:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80077f:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800782:	89 ec                	mov    %ebp,%esp
  800784:	5d                   	pop    %ebp
  800785:	c3                   	ret    
	...
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800be0:	e8 2d f9 ff ff       	call   800512 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800d2e:	e8 4b f8 ff ff       	call   80057e <sys_page_map>
  ...
  800d69:	e8 10 f8 ff ff       	call   80057e <sys_page_map>
...
alloc_sockfd(int sockid)
{
  ...
  801138:	e8 af f4 ff ff       	call   8005ec <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  801575:	e8 61 f1 ff ff       	call   8006db <sys_getenvid>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801610:	e8 db ea ff ff       	call   8000f0 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  801664:	e8 87 ea ff ff       	call   8000f0 <sys_cputs>
		b->idx = 0;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8023b3:	e8 d5 df ff ff       	call   80038d <sys_ipc_try_send>
  ...
  8023d0:	e8 b8 df ff ff       	call   80038d <sys_ipc_try_send>
           if(ret == 0)
  ...
  8023f5:	e8 6a f1 ff ff       	call   801564 <_panic>
           sys_yield();
  8023fa:	e8 5a e2 ff ff       	call   800659 <sys_yield>
        }
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802425:	e8 f8 de ff ff       	call   800322 <sys_ipc_recv>
  80242a:	eb 08                	jmp    802434 <ipc_recv+0x2b>
        else
           ret = sys_ipc_recv(pg);
  80242c:	89 04 24             	mov    %eax,(%esp)
  80242f:	e8 ee de ff ff       	call   800322 <sys_ipc_recv>
        if(ret == 0){
