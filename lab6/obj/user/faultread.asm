...
umain(int argc, char **argv)
{
  ...
  800043:	c7 04 24 60 27 80 00 	movl   $0x802760,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  800066:	e8 0c 14 00 00       	call   801477 <sys_getenvid>
...
exit(void)
{
  ...
  8000ab:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000ae:	e8 58 19 00 00       	call   801a0b <close_all>
	sys_env_destroy(0);
  8000b3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000ba:	e8 f8 13 00 00       	call   8014b7 <sys_env_destroy>
}
  8000bf:	c9                   	leave  
  8000c0:	c3                   	ret    
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800270:	0f be 80 88 27 80 00 	movsbl 0x802788(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800426:	c7 44 24 08 99 27 80 	movl   $0x802799,0x8(%esp)
  80042d:	00 
  ...
  80048a:	be a2 27 80 00       	mov    $0x8027a2,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800789:	0f be 80 88 27 80 00 	movsbl 0x802788(%eax),%eax
  ...
  800835:	c7 44 24 0c bc 28 80 	movl   $0x8028bc,0xc(%esp)
  80083c:	00 
  ...
  80086b:	c7 44 24 0c f4 28 80 	movl   $0x8028f4,0xc(%esp)
  800872:	00 
  ...
  800908:	0f be 80 88 27 80 00 	movsbl 0x802788(%eax),%eax
  ...
  80094a:	0f be 80 88 27 80 00 	movsbl 0x802788(%eax),%eax
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801693:	e8 8d ea ff ff       	call   800125 <cprintf>
	*dev = 0;
  ...
  8017d1:	e8 6b fe ff ff       	call   801641 <dev_lookup>
{
  ...
  8017fa:	e8 26 e9 ff ff       	call   800125 <cprintf>
  ...
  80185a:	e8 e2 fd ff ff       	call   801641 <dev_lookup>
{
  ...
  801888:	e8 98 e8 ff ff       	call   800125 <cprintf>
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  802337:	e8 e9 dd ff ff       	call   800125 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80233c:	89 74 24 04          	mov    %esi,0x4(%esp)
  802340:	8b 45 10             	mov    0x10(%ebp),%eax
  802343:	89 04 24             	mov    %eax,(%esp)
  802346:	e8 79 dd ff ff       	call   8000c4 <vcprintf>
	cprintf("\n");
  80234b:	c7 04 24 7c 27 80 00 	movl   $0x80277c,(%esp)
  802352:	e8 ce dd ff ff       	call   800125 <cprintf>
