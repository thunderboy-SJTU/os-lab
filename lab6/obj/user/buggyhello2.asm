...
libmain(int argc, char **argv)
{
  ...
  800066:	e8 84 06 00 00       	call   8006ef <sys_getenvid>
...
exit(void)
{
  ...
  8000ab:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000ae:	e8 c8 0b 00 00       	call   800c7b <close_all>
	sys_env_destroy(0);
  8000b3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000ba:	e8 70 06 00 00       	call   80072f <sys_env_destroy>
}
  8000bf:	c9                   	leave  
  8000c0:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800155:	b8 13 00 00 00       	mov    $0x13,%eax
  80015a:	8b 55 08             	mov    0x8(%ebp),%edx
  80015d:	89 cb                	mov    %ecx,%ebx
  80015f:	89 cf                	mov    %ecx,%edi
  800161:	51                   	push   %ecx
  800162:	52                   	push   %edx
  800163:	53                   	push   %ebx
  800164:	54                   	push   %esp
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800196:	b8 12 00 00 00       	mov    $0x12,%eax
  ...
  8001aa:	54                   	push   %esp
  8001ab:	5d                   	pop    %ebp
  8001ac:	8d 35 b4 01 80 00    	lea    0x8001b4,%esi
  8001b2:	0f 34                	sysenter 
  8001b4:	5f                   	pop    %edi
  8001b5:	5e                   	pop    %esi
  8001b6:	5d                   	pop    %ebp
  8001b7:	5c                   	pop    %esp
...
sys_receive_packet(uint32_t addr,int* len){
  ...
  8001bb:	8b 1c 24             	mov    (%esp),%ebx
  8001be:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8001c2:	89 ec                	mov    %ebp,%esp
  8001c4:	5d                   	pop    %ebp
  8001c5:	c3                   	ret    

008001c6 <sys_transmit_packet>:
...
sys_transmit_packet(uint32_t addr,int len){
  ...
  8001cf:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001d8:	b8 11 00 00 00       	mov    $0x11,%eax
  ...
  8001ec:	54                   	push   %esp
  8001ed:	5d                   	pop    %ebp
  8001ee:	8d 35 f6 01 80 00    	lea    0x8001f6,%esi
  8001f4:	0f 34                	sysenter 
  8001f6:	5f                   	pop    %edi
  8001f7:	5e                   	pop    %esi
  8001f8:	5d                   	pop    %ebp
  8001f9:	5c                   	pop    %esp
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800215:	b8 10 00 00 00       	mov    $0x10,%eax
  ...
  80022d:	54                   	push   %esp
  80022e:	5d                   	pop    %ebp
  80022f:	8d 35 37 02 80 00    	lea    0x800237,%esi
  800235:	0f 34                	sysenter 
  800237:	5f                   	pop    %edi
  800238:	5e                   	pop    %esi
  800239:	5d                   	pop    %ebp
  80023a:	5c                   	pop    %esp
...
sys_exec(void* vph, uint32_t phnum, uint32_t esp, uint32_t eip){
  ...
  80023e:	8b 1c 24             	mov    (%esp),%ebx
  800241:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800245:	89 ec                	mov    %ebp,%esp
  800247:	5d                   	pop    %ebp
  800248:	c3                   	ret    

00800249 <sys_env_set_prior>:
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  80024f:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80025a:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  80026e:	54                   	push   %esp
  80026f:	5d                   	pop    %ebp
  800270:	8d 35 78 02 80 00    	lea    0x800278,%esi
  800276:	0f 34                	sysenter 
  800278:	5f                   	pop    %edi
  800279:	5e                   	pop    %esi
  80027a:	5d                   	pop    %ebp
  80027b:	5c                   	pop    %esp
  ...
  800281:	7e 28                	jle    8002ab <sys_env_set_prior+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800283:	89 44 24 10          	mov    %eax,0x10(%esp)
  800287:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  80028e:	00 
  80028f:	c7 44 24 08 58 27 80 	movl   $0x802758,0x8(%esp)
  800296:	00 
  800297:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80029e:	00 
  80029f:	c7 04 24 75 27 80 00 	movl   $0x802775,(%esp)
  8002a6:	e8 c9 12 00 00       	call   801574 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002c7:	b8 15 00 00 00       	mov    $0x15,%eax
...
sys_time_msec(void)
{
  ...
  8002ea:	8b 1c 24             	mov    (%esp),%ebx
  8002ed:	8b 7c 24 04          	mov    0x4(%esp),%edi
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800307:	b8 14 00 00 00       	mov    $0x14,%eax
  ...
  80031a:	54                   	push   %esp
  80031b:	5d                   	pop    %ebp
  80031c:	8d 35 24 03 80 00    	lea    0x800324,%esi
  800322:	0f 34                	sysenter 
  800324:	5f                   	pop    %edi
  800325:	5e                   	pop    %esi
  800326:	5d                   	pop    %ebp
  800327:	5c                   	pop    %esp
...
sys_sbrk(uint32_t inc)
{
  ...
  80032b:	8b 1c 24             	mov    (%esp),%ebx
  80032e:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800332:	89 ec                	mov    %ebp,%esp
  800334:	5d                   	pop    %ebp
  800335:	c3                   	ret    
...
sys_ipc_recv(void *dstva)
{
  ...
  800339:	83 ec 28             	sub    $0x28,%esp
  80033c:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80033f:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800347:	b8 0e 00 00 00       	mov    $0xe,%eax
  ...
  80036d:	7e 28                	jle    800397 <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  80036f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800373:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  80037a:	00 
  80037b:	c7 44 24 08 58 27 80 	movl   $0x802758,0x8(%esp)
  800382:	00 
  800383:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80038a:	00 
  80038b:	c7 04 24 75 27 80 00 	movl   $0x802775,(%esp)
  800392:	e8 dd 11 00 00       	call   801574 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800397:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8003ae:	b8 0d 00 00 00       	mov    $0xd,%eax
  8003b3:	8b 7d 14             	mov    0x14(%ebp),%edi
  8003b6:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8003b9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  8003c6:	54                   	push   %esp
  8003c7:	5d                   	pop    %ebp
  8003c8:	8d 35 d0 03 80 00    	lea    0x8003d0,%esi
  8003ce:	0f 34                	sysenter 
  8003d0:	5f                   	pop    %edi
  8003d1:	5e                   	pop    %esi
  8003d2:	5d                   	pop    %ebp
  8003d3:	5c                   	pop    %esp
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8003da:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8003de:	89 ec                	mov    %ebp,%esp
  8003e0:	5d                   	pop    %ebp
  8003e1:	c3                   	ret    

008003e2 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8003e8:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8003f3:	b8 0b 00 00 00       	mov    $0xb,%eax
  ...
  80041a:	7e 28                	jle    800444 <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80041c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800420:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  800427:	00 
  800428:	c7 44 24 08 58 27 80 	movl   $0x802758,0x8(%esp)
  80042f:	00 
  800430:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800437:	00 
  800438:	c7 04 24 75 27 80 00 	movl   $0x802775,(%esp)
  80043f:	e8 30 11 00 00       	call   801574 <_panic>
...
0080044e <sys_env_set_trapframe>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80045f:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  800473:	54                   	push   %esp
  800474:	5d                   	pop    %ebp
  800475:	8d 35 7d 04 80 00    	lea    0x80047d,%esi
  80047b:	0f 34                	sysenter 
  80047d:	5f                   	pop    %edi
  80047e:	5e                   	pop    %esi
  80047f:	5d                   	pop    %ebp
  800480:	5c                   	pop    %esp
  ...
  800486:	7e 28                	jle    8004b0 <sys_env_set_trapframe+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800488:	89 44 24 10          	mov    %eax,0x10(%esp)
  80048c:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800493:	00 
  800494:	c7 44 24 08 58 27 80 	movl   $0x802758,0x8(%esp)
  80049b:	00 
  80049c:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8004a3:	00 
  8004a4:	c7 04 24 75 27 80 00 	movl   $0x802775,(%esp)
  8004ab:	e8 c4 10 00 00       	call   801574 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8004b0:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8004b3:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004b6:	89 ec                	mov    %ebp,%esp
  8004b8:	5d                   	pop    %ebp
  8004b9:	c3                   	ret    

008004ba <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8004bd:	83 ec 28             	sub    $0x28,%esp
  8004c0:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8004c3:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8004cb:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8004f2:	7e 28                	jle    80051c <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004f4:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004f8:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8004ff:	00 
  800500:	c7 44 24 08 58 27 80 	movl   $0x802758,0x8(%esp)
  800507:	00 
  800508:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80050f:	00 
  800510:	c7 04 24 75 27 80 00 	movl   $0x802775,(%esp)
  800517:	e8 58 10 00 00       	call   801574 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80051c:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80051f:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800522:	89 ec                	mov    %ebp,%esp
  800524:	5d                   	pop    %ebp
  800525:	c3                   	ret    

00800526 <sys_page_unmap>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800537:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  80054b:	54                   	push   %esp
  80054c:	5d                   	pop    %ebp
  80054d:	8d 35 55 05 80 00    	lea    0x800555,%esi
  800553:	0f 34                	sysenter 
  800555:	5f                   	pop    %edi
  800556:	5e                   	pop    %esi
  800557:	5d                   	pop    %ebp
  800558:	5c                   	pop    %esp
  ...
  80055e:	7e 28                	jle    800588 <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800560:	89 44 24 10          	mov    %eax,0x10(%esp)
  800564:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  80056b:	00 
  80056c:	c7 44 24 08 58 27 80 	movl   $0x802758,0x8(%esp)
  800573:	00 
  800574:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80057b:	00 
  80057c:	c7 04 24 75 27 80 00 	movl   $0x802775,(%esp)
  800583:	e8 ec 0f 00 00       	call   801574 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800588:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80058b:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80058e:	89 ec                	mov    %ebp,%esp
  800590:	5d                   	pop    %ebp
  800591:	c3                   	ret    

00800592 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800598:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80059b:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  80059e:	8b 7d 18             	mov    0x18(%ebp),%edi
  8005a1:	0b 7d 14             	or     0x14(%ebp),%edi
  8005a4:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  8005b9:	54                   	push   %esp
  8005ba:	5d                   	pop    %ebp
  8005bb:	8d 35 c3 05 80 00    	lea    0x8005c3,%esi
  8005c1:	0f 34                	sysenter 
  8005c3:	5f                   	pop    %edi
  8005c4:	5e                   	pop    %esi
  8005c5:	5d                   	pop    %ebp
  8005c6:	5c                   	pop    %esp
  ...
  8005cc:	7e 28                	jle    8005f6 <sys_page_map+0x64>
		panic("syscall %d returned %d (> 0)", num, ret);
  8005ce:	89 44 24 10          	mov    %eax,0x10(%esp)
  8005d2:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  8005d9:	00 
  8005da:	c7 44 24 08 58 27 80 	movl   $0x802758,0x8(%esp)
  8005e1:	00 
  8005e2:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8005e9:	00 
  8005ea:	c7 04 24 75 27 80 00 	movl   $0x802775,(%esp)
  8005f1:	e8 7e 0f 00 00       	call   801574 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8005f6:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8005f9:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8005fc:	89 ec                	mov    %ebp,%esp
  8005fe:	5d                   	pop    %ebp
  8005ff:	c3                   	ret    

00800600 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800606:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800609:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800611:	b8 05 00 00 00       	mov    $0x5,%eax
  ...
  800626:	54                   	push   %esp
  800627:	5d                   	pop    %ebp
  800628:	8d 35 30 06 80 00    	lea    0x800630,%esi
  80062e:	0f 34                	sysenter 
  800630:	5f                   	pop    %edi
  800631:	5e                   	pop    %esi
  800632:	5d                   	pop    %ebp
  800633:	5c                   	pop    %esp
  ...
  800639:	7e 28                	jle    800663 <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  80063b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80063f:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800646:	00 
  800647:	c7 44 24 08 58 27 80 	movl   $0x802758,0x8(%esp)
  80064e:	00 
  80064f:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800656:	00 
  800657:	c7 04 24 75 27 80 00 	movl   $0x802775,(%esp)
  80065e:	e8 11 0f 00 00       	call   801574 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800663:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800666:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800669:	89 ec                	mov    %ebp,%esp
  80066b:	5d                   	pop    %ebp
  80066c:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80067f:	b8 0c 00 00 00       	mov    $0xc,%eax
  800684:	89 d1                	mov    %edx,%ecx
  ...
  800691:	54                   	push   %esp
  800692:	5d                   	pop    %ebp
  800693:	8d 35 9b 06 80 00    	lea    0x80069b,%esi
  800699:	0f 34                	sysenter 
  80069b:	5f                   	pop    %edi
  80069c:	5e                   	pop    %esi
  80069d:	5d                   	pop    %ebp
  80069e:	5c                   	pop    %esp
...
sys_yield(void)
{
  ...
  8006a2:	8b 1c 24             	mov    (%esp),%ebx
  8006a5:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8006a9:	89 ec                	mov    %ebp,%esp
  8006ab:	5d                   	pop    %ebp
  8006ac:	c3                   	ret    

008006ad <sys_map_kernel_page>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8006bf:	b8 04 00 00 00       	mov    $0x4,%eax
  ...
  8006d3:	54                   	push   %esp
  8006d4:	5d                   	pop    %ebp
  8006d5:	8d 35 dd 06 80 00    	lea    0x8006dd,%esi
  8006db:	0f 34                	sysenter 
  8006dd:	5f                   	pop    %edi
  8006de:	5e                   	pop    %esi
  8006df:	5d                   	pop    %ebp
  8006e0:	5c                   	pop    %esp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  8006e4:	8b 1c 24             	mov    (%esp),%ebx
  8006e7:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8006eb:	89 ec                	mov    %ebp,%esp
  8006ed:	5d                   	pop    %ebp
  8006ee:	c3                   	ret    

008006ef <sys_getenvid>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800701:	b8 02 00 00 00       	mov    $0x2,%eax
  800706:	89 d1                	mov    %edx,%ecx
  800708:	89 d3                	mov    %edx,%ebx
  ...
  800713:	54                   	push   %esp
  800714:	5d                   	pop    %ebp
  800715:	8d 35 1d 07 80 00    	lea    0x80071d,%esi
  80071b:	0f 34                	sysenter 
  80071d:	5f                   	pop    %edi
  80071e:	5e                   	pop    %esi
  80071f:	5d                   	pop    %ebp
  800720:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  800724:	8b 1c 24             	mov    (%esp),%ebx
  800727:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80072b:	89 ec                	mov    %ebp,%esp
  80072d:	5d                   	pop    %ebp
  80072e:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  800735:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800738:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800740:	b8 03 00 00 00       	mov    $0x3,%eax
  800745:	8b 55 08             	mov    0x8(%ebp),%edx
  800748:	89 cb                	mov    %ecx,%ebx
  ...
  800753:	54                   	push   %esp
  800754:	5d                   	pop    %ebp
  800755:	8d 35 5d 07 80 00    	lea    0x80075d,%esi
  80075b:	0f 34                	sysenter 
  80075d:	5f                   	pop    %edi
  80075e:	5e                   	pop    %esi
  80075f:	5d                   	pop    %ebp
  800760:	5c                   	pop    %esp
  ...
  800766:	7e 28                	jle    800790 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800768:	89 44 24 10          	mov    %eax,0x10(%esp)
  80076c:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800773:	00 
  800774:	c7 44 24 08 58 27 80 	movl   $0x802758,0x8(%esp)
  80077b:	00 
  80077c:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800783:	00 
  800784:	c7 04 24 75 27 80 00 	movl   $0x802775,(%esp)
  80078b:	e8 e4 0d 00 00       	call   801574 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800790:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800793:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800796:	89 ec                	mov    %ebp,%esp
  800798:	5d                   	pop    %ebp
  800799:	c3                   	ret    
  80079a:	00 00                	add    %al,(%eax)
...
{
	&devfile,
  8008bf:	b8 08 30 80 00       	mov    $0x803008,%eax
{
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  8008c9:	be 00 28 80 00       	mov    $0x802800,%esi
		if (devtab[i]->dev_id == dev_id) {
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8008fc:	c7 04 24 84 27 80 00 	movl   $0x802784,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8009e1:	c7 04 24 a4 27 80 00 	movl   $0x8027a4,(%esp)
  ...
  800a41:	e8 6b fe ff ff       	call   8008b1 <dev_lookup>
{
  ...
  800a63:	c7 04 24 c5 27 80 00 	movl   $0x8027c5,(%esp)
  ...
  800aca:	e8 e2 fd ff ff       	call   8008b1 <dev_lookup>
{
  ...
  800af1:	c7 04 24 e2 27 80 00 	movl   $0x8027e2,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800bf0:	e8 31 f9 ff ff       	call   800526 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800d3e:	e8 4f f8 ff ff       	call   800592 <sys_page_map>
  ...
  800d79:	e8 14 f8 ff ff       	call   800592 <sys_page_map>
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801076:	c7 44 24 04 0c 28 80 	movl   $0x80280c,0x4(%esp)
  80107d:	00 
...
alloc_sockfd(int sockid)
{
  ...
  801148:	e8 b3 f4 ff ff       	call   800600 <sys_page_alloc>
...
alloc_sockfd(int sockid)
{
  ...
  80115d:	8b 15 24 30 80 00    	mov    0x803024,%edx
...
fd2sockid(int fd)
{
  ...
  8011db:	3b 0d 24 30 80 00    	cmp    0x803024,%ecx
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8013c8:	c7 44 24 0c 18 28 80 	movl   $0x802818,0xc(%esp)
  8013cf:	00 
  8013d0:	c7 44 24 08 24 28 80 	movl   $0x802824,0x8(%esp)
  8013d7:	00 
  8013d8:	c7 44 24 04 6c 00 00 	movl   $0x6c,0x4(%esp)
  8013df:	00 
  8013e0:	c7 04 24 39 28 80 00 	movl   $0x802839,(%esp)
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  80145d:	c7 44 24 0c 45 28 80 	movl   $0x802845,0xc(%esp)
  801464:	00 
  801465:	c7 44 24 08 24 28 80 	movl   $0x802824,0x8(%esp)
  80146c:	00 
  80146d:	c7 44 24 04 61 00 00 	movl   $0x61,0x4(%esp)
  801474:	00 
  801475:	c7 04 24 39 28 80 00 	movl   $0x802839,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  80157f:	8b 1d 04 30 80 00    	mov    0x803004,%ebx
  801585:	e8 65 f1 ff ff       	call   8006ef <sys_getenvid>
  ...
  8015a0:	c7 04 24 5c 28 80 00 	movl   $0x80285c,(%esp)
  ...
  8015b6:	e8 11 00 00 00       	call   8015cc <vcprintf>
	cprintf("\n");
  8015bb:	c7 04 24 4c 27 80 00 	movl   $0x80274c,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801620:	e8 df ea ff ff       	call   800104 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  801674:	e8 8b ea ff ff       	call   800104 <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801770:	0f be 80 7f 28 80 00 	movsbl 0x80287f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801926:	c7 44 24 08 90 28 80 	movl   $0x802890,0x8(%esp)
  80192d:	00 
  ...
  80194c:	c7 44 24 08 36 28 80 	movl   $0x802836,0x8(%esp)
  801953:	00 
  ...
  80198a:	be 99 28 80 00       	mov    $0x802899,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801c89:	0f be 80 7f 28 80 00 	movsbl 0x80287f(%eax),%eax
  ...
  801d35:	c7 44 24 0c b4 29 80 	movl   $0x8029b4,0xc(%esp)
  801d3c:	00 
  801d3d:	c7 44 24 08 36 28 80 	movl   $0x802836,0x8(%esp)
  801d44:	00 
  ...
  801d6b:	c7 44 24 0c ec 29 80 	movl   $0x8029ec,0xc(%esp)
  801d72:	00 
  801d73:	c7 44 24 08 36 28 80 	movl   $0x802836,0x8(%esp)
  801d7a:	00 
  ...
  801e08:	0f be 80 7f 28 80 00 	movsbl 0x80287f(%eax),%eax
  ...
  801e4a:	0f be 80 7f 28 80 00 	movsbl 0x80287f(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8023c3:	e8 d9 df ff ff       	call   8003a1 <sys_ipc_try_send>
  ...
  8023e0:	e8 bc df ff ff       	call   8003a1 <sys_ipc_try_send>
           if(ret == 0)
  ...
  802405:	e8 6a f1 ff ff       	call   801574 <_panic>
           sys_yield();
  80240a:	e8 5e e2 ff ff       	call   80066d <sys_yield>
        }
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802435:	e8 fc de ff ff       	call   800336 <sys_ipc_recv>
  80243a:	eb 08                	jmp    802444 <ipc_recv+0x2b>
        else
           ret = sys_ipc_recv(pg);
  80243c:	89 04 24             	mov    %eax,(%esp)
  80243f:	e8 f2 de ff ff       	call   800336 <sys_ipc_recv>
        if(ret == 0){
