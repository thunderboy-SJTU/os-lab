	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800260:	0f be 80 71 16 80 00 	movsbl 0x801671(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80034a:	ff 24 95 c0 17 80 00 	jmp    *0x8017c0(,%edx,4)
  ...
  80043c:	c7 44 24 08 8b 16 80 	movl   $0x80168b,0x8(%esp)
  800443:	00 
  ...
  80047a:	be 8e 16 80 00       	mov    $0x80168e,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800779:	0f be 80 71 16 80 00 	movsbl 0x801671(%eax),%eax
  ...
  800825:	c7 44 24 0c 28 17 80 	movl   $0x801728,0xc(%esp)
  80082c:	00 
  80082d:	c7 44 24 08 8b 16 80 	movl   $0x80168b,0x8(%esp)
  800834:	00 
  ...
  80085b:	c7 44 24 0c 60 17 80 	movl   $0x801760,0xc(%esp)
  800862:	00 
  800863:	c7 44 24 08 8b 16 80 	movl   $0x80168b,0x8(%esp)
  80086a:	00 
  ...
  8008f8:	0f be 80 71 16 80 00 	movsbl 0x801671(%eax),%eax
  ...
  80093a:	0f be 80 71 16 80 00 	movsbl 0x801671(%eax),%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f00:	00 
  800f01:	c7 44 24 08 44 19 80 	movl   $0x801944,0x8(%esp)
  800f08:	00 
  800f09:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800f10:	00 
  800f11:	c7 04 24 61 19 80 00 	movl   $0x801961,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800fac:	00 
  800fad:	c7 44 24 08 44 19 80 	movl   $0x801944,0x8(%esp)
  800fb4:	00 
  800fb5:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800fbc:	00 
  800fbd:	c7 04 24 61 19 80 00 	movl   $0x801961,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801059:	00 
  80105a:	c7 44 24 08 44 19 80 	movl   $0x801944,0x8(%esp)
  801061:	00 
  801062:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801069:	00 
  80106a:	c7 04 24 61 19 80 00 	movl   $0x801961,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8010c5:	00 
  8010c6:	c7 44 24 08 44 19 80 	movl   $0x801944,0x8(%esp)
  8010cd:	00 
  8010ce:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8010d5:	00 
  8010d6:	c7 04 24 61 19 80 00 	movl   $0x801961,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801131:	00 
  801132:	c7 44 24 08 44 19 80 	movl   $0x801944,0x8(%esp)
  801139:	00 
  80113a:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801141:	00 
  801142:	c7 04 24 61 19 80 00 	movl   $0x801961,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80119f:	00 
  8011a0:	c7 44 24 08 44 19 80 	movl   $0x801944,0x8(%esp)
  8011a7:	00 
  8011a8:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8011af:	00 
  8011b0:	c7 04 24 61 19 80 00 	movl   $0x801961,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80120c:	00 
  80120d:	c7 44 24 08 44 19 80 	movl   $0x801944,0x8(%esp)
  801214:	00 
  801215:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80121c:	00 
  80121d:	c7 04 24 61 19 80 00 	movl   $0x801961,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801339:	00 
  80133a:	c7 44 24 08 44 19 80 	movl   $0x801944,0x8(%esp)
  801341:	00 
  801342:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801349:	00 
  80134a:	c7 04 24 61 19 80 00 	movl   $0x801961,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  801378:	c7 04 24 6f 19 80 00 	movl   $0x80196f,(%esp)
  ...
  8013a5:	c7 04 24 78 19 80 00 	movl   $0x801978,(%esp)
  ...
  8013bb:	e8 fc ec ff ff       	call   8000bc <vcprintf>
	cprintf("\n");
  8013c0:	c7 04 24 74 19 80 00 	movl   $0x801974,(%esp)
