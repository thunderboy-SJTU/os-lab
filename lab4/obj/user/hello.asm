...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  80003a:	c7 04 24 60 16 80 00 	movl   $0x801660,(%esp)
  ...
  800052:	c7 04 24 6e 16 80 00 	movl   $0x80166e,(%esp)
  800059:	e8 cb 00 00 00       	call   800129 <cprintf>
}
  80005e:	c9                   	leave  
  80005f:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800072:	e8 4e 12 00 00       	call   8012c5 <sys_getenvid>
...
exit(void)
{
  ...
  8000c1:	e8 3f 12 00 00       	call   801305 <sys_env_destroy>
}
  8000c6:	c9                   	leave  
  8000c7:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8000cb:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;

	b.idx = 0;
  8000d1:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  8000d8:	00 00 00 
	b.cnt = 0;
  8000db:	c7 85 f4 fe ff ff 00 	movl   $0x0,-0x10c(%ebp)
  8000e2:	00 00 00 
	vprintfmt((void*)putch, &b, fmt, ap);
  8000e5:	8b 45 0c             	mov    0xc(%ebp),%eax
  8000e8:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8000ec:	8b 45 08             	mov    0x8(%ebp),%eax
  8000ef:	89 44 24 08          	mov    %eax,0x8(%esp)
  8000f3:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  8000f9:	89 44 24 04          	mov    %eax,0x4(%esp)
  8000fd:	c7 04 24 43 01 80 00 	movl   $0x800143,(%esp)
  800104:	e8 d3 01 00 00       	call   8002dc <vprintfmt>
	sys_cputs(b.buf, b.idx);
  800109:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  80010f:	89 44 24 04          	mov    %eax,0x4(%esp)
  800113:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  800119:	89 04 24             	mov    %eax,(%esp)
  80011c:	e8 6b 0d 00 00       	call   800e8c <sys_cputs>
  ...
  80012f:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  80013c:	e8 87 ff ff ff       	call   8000c8 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  800152:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800156:	83 c0 01             	add    $0x1,%eax
  800159:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  80015b:	3d ff 00 00 00       	cmp    $0xff,%eax
  800160:	75 19                	jne    80017b <putch+0x38>
		sys_cputs(b->buf, b->idx);
  800162:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800169:	00 
  80016a:	8d 43 08             	lea    0x8(%ebx),%eax
  80016d:	89 04 24             	mov    %eax,(%esp)
  800170:	e8 17 0d 00 00       	call   800e8c <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800270:	0f be 80 8f 16 80 00 	movsbl 0x80168f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80035a:	ff 24 95 e0 17 80 00 	jmp    *0x8017e0(,%edx,4)
  ...
  80044c:	c7 44 24 08 a9 16 80 	movl   $0x8016a9,0x8(%esp)
  800453:	00 
  ...
  80048a:	be ac 16 80 00       	mov    $0x8016ac,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800789:	0f be 80 8f 16 80 00 	movsbl 0x80168f(%eax),%eax
  ...
  800835:	c7 44 24 0c 48 17 80 	movl   $0x801748,0xc(%esp)
  80083c:	00 
  80083d:	c7 44 24 08 a9 16 80 	movl   $0x8016a9,0x8(%esp)
  800844:	00 
  ...
  80086b:	c7 44 24 0c 80 17 80 	movl   $0x801780,0xc(%esp)
  800872:	00 
  800873:	c7 44 24 08 a9 16 80 	movl   $0x8016a9,0x8(%esp)
  80087a:	00 
  ...
  800908:	0f be 80 8f 16 80 00 	movsbl 0x80168f(%eax),%eax
  ...
  80094a:	0f be 80 8f 16 80 00 	movsbl 0x80168f(%eax),%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f10:	00 
  800f11:	c7 44 24 08 64 19 80 	movl   $0x801964,0x8(%esp)
  800f18:	00 
  800f19:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800f20:	00 
  800f21:	c7 04 24 81 19 80 00 	movl   $0x801981,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800fbc:	00 
  800fbd:	c7 44 24 08 64 19 80 	movl   $0x801964,0x8(%esp)
  800fc4:	00 
  800fc5:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800fcc:	00 
  800fcd:	c7 04 24 81 19 80 00 	movl   $0x801981,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801069:	00 
  80106a:	c7 44 24 08 64 19 80 	movl   $0x801964,0x8(%esp)
  801071:	00 
  801072:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801079:	00 
  80107a:	c7 04 24 81 19 80 00 	movl   $0x801981,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8010d5:	00 
  8010d6:	c7 44 24 08 64 19 80 	movl   $0x801964,0x8(%esp)
  8010dd:	00 
  8010de:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8010e5:	00 
  8010e6:	c7 04 24 81 19 80 00 	movl   $0x801981,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801141:	00 
  801142:	c7 44 24 08 64 19 80 	movl   $0x801964,0x8(%esp)
  801149:	00 
  80114a:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801151:	00 
  801152:	c7 04 24 81 19 80 00 	movl   $0x801981,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8011af:	00 
  8011b0:	c7 44 24 08 64 19 80 	movl   $0x801964,0x8(%esp)
  8011b7:	00 
  8011b8:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8011bf:	00 
  8011c0:	c7 04 24 81 19 80 00 	movl   $0x801981,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80121c:	00 
  80121d:	c7 44 24 08 64 19 80 	movl   $0x801964,0x8(%esp)
  801224:	00 
  801225:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80122c:	00 
  80122d:	c7 04 24 81 19 80 00 	movl   $0x801981,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801349:	00 
  80134a:	c7 44 24 08 64 19 80 	movl   $0x801964,0x8(%esp)
  801351:	00 
  801352:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801359:	00 
  80135a:	c7 04 24 81 19 80 00 	movl   $0x801981,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  801378:	8d 75 14             	lea    0x14(%ebp),%esi
	...
	if (argv0)
  80137b:	a1 08 20 80 00       	mov    0x802008,%eax
  801380:	85 c0                	test   %eax,%eax
  801382:	74 10                	je     801394 <_panic+0x24>
		cprintf("%s: ", argv0);
  801384:	89 44 24 04          	mov    %eax,0x4(%esp)
  801388:	c7 04 24 8f 19 80 00 	movl   $0x80198f,(%esp)
  80138f:	e8 95 ed ff ff       	call   800129 <cprintf>
  ...
  8013b5:	c7 04 24 94 19 80 00 	movl   $0x801994,(%esp)
  8013bc:	e8 68 ed ff ff       	call   800129 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8013c1:	89 74 24 04          	mov    %esi,0x4(%esp)
  8013c5:	8b 45 10             	mov    0x10(%ebp),%eax
  8013c8:	89 04 24             	mov    %eax,(%esp)
  8013cb:	e8 f8 ec ff ff       	call   8000c8 <vcprintf>
	cprintf("\n");
  8013d0:	c7 04 24 6c 16 80 00 	movl   $0x80166c,(%esp)
  8013d7:	e8 4d ed ff ff       	call   800129 <cprintf>
