...
umain(int argc, char **argv)
{
  ...
  80004a:	e8 ad 00 00 00       	call   8000fc <sys_cputs>
}
  80004f:	c9                   	leave  
  800050:	c3                   	ret    
...
libmain(int argc, char **argv)
{
  ...
  800066:	e8 ca 04 00 00       	call   800535 <sys_getenvid>
  ...
  80007c:	a3 08 20 80 00       	mov    %eax,0x802008
...
exit(void)
{
  ...
  8000b5:	e8 bb 04 00 00       	call   800575 <sys_env_destroy>
}
  8000ba:	c9                   	leave  
  8000bb:	c3                   	ret    
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  80013e:	83 ec 28             	sub    $0x28,%esp
  800141:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800144:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800147:	bb 00 00 00 00       	mov    $0x0,%ebx
  80014c:	b8 0e 00 00 00       	mov    $0xe,%eax
  800151:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800154:	8b 55 08             	mov    0x8(%ebp),%edx
  800157:	89 df                	mov    %ebx,%edi
  800159:	51                   	push   %ecx
  80015a:	52                   	push   %edx
  80015b:	53                   	push   %ebx
  80015c:	54                   	push   %esp
  ...
  800173:	7e 28                	jle    80019d <sys_env_set_prior+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800175:	89 44 24 10          	mov    %eax,0x10(%esp)
  800179:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  800180:	00 
  800181:	c7 44 24 08 58 16 80 	movl   $0x801658,0x8(%esp)
  800188:	00 
  800189:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800190:	00 
  800191:	c7 04 24 75 16 80 00 	movl   $0x801675,(%esp)
  800198:	e8 43 04 00 00       	call   8005e0 <_panic>
}
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  80019d:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8001a0:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_sbrk(uint32_t inc)
{
  ...
  8001b0:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
sys_sbrk(uint32_t inc)
{
  ...
  8001e0:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8001e4:	89 ec                	mov    %ebp,%esp
  8001e6:	5d                   	pop    %ebp
  8001e7:	c3                   	ret    

008001e8 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  8001eb:	83 ec 28             	sub    $0x28,%esp
  8001ee:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8001f1:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001f9:	b8 0d 00 00 00       	mov    $0xd,%eax
  8001fe:	8b 55 08             	mov    0x8(%ebp),%edx
  800201:	89 cb                	mov    %ecx,%ebx
  800203:	89 cf                	mov    %ecx,%edi
  800205:	51                   	push   %ecx
  800206:	52                   	push   %edx
  800207:	53                   	push   %ebx
  800208:	54                   	push   %esp
  ...
  80020c:	54                   	push   %esp
  80020d:	5d                   	pop    %ebp
  80020e:	8d 35 16 02 80 00    	lea    0x800216,%esi
  800214:	0f 34                	sysenter 
  800216:	5f                   	pop    %edi
  800217:	5e                   	pop    %esi
  800218:	5d                   	pop    %ebp
  800219:	5c                   	pop    %esp
  ...
  80021f:	7e 28                	jle    800249 <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800221:	89 44 24 10          	mov    %eax,0x10(%esp)
  800225:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  80022c:	00 
  80022d:	c7 44 24 08 58 16 80 	movl   $0x801658,0x8(%esp)
  800234:	00 
  800235:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80023c:	00 
  80023d:	c7 04 24 75 16 80 00 	movl   $0x801675,(%esp)
  800244:	e8 97 03 00 00       	call   8005e0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800249:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800278:	54                   	push   %esp
  800279:	5d                   	pop    %ebp
  80027a:	8d 35 82 02 80 00    	lea    0x800282,%esi
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800289:	8b 1c 24             	mov    (%esp),%ebx
  80028c:	8b 7c 24 04          	mov    0x4(%esp),%edi
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800297:	83 ec 28             	sub    $0x28,%esp
  80029a:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002a5:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  8002cc:	7e 28                	jle    8002f6 <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002ce:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002d2:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  8002d9:	00 
  8002da:	c7 44 24 08 58 16 80 	movl   $0x801658,0x8(%esp)
  8002e1:	00 
  8002e2:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8002e9:	00 
  8002ea:	c7 04 24 75 16 80 00 	movl   $0x801675,(%esp)
  8002f1:	e8 ea 02 00 00       	call   8005e0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002f6:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8002f9:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002fc:	89 ec                	mov    %ebp,%esp
  8002fe:	5d                   	pop    %ebp
  8002ff:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800309:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800311:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  800325:	54                   	push   %esp
  800326:	5d                   	pop    %ebp
  800327:	8d 35 2f 03 80 00    	lea    0x80032f,%esi
  80032d:	0f 34                	sysenter 
  80032f:	5f                   	pop    %edi
  800330:	5e                   	pop    %esi
  800331:	5d                   	pop    %ebp
  800332:	5c                   	pop    %esp
  ...
  800338:	7e 28                	jle    800362 <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80033a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80033e:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800345:	00 
  800346:	c7 44 24 08 58 16 80 	movl   $0x801658,0x8(%esp)
  80034d:	00 
  80034e:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800355:	00 
  800356:	c7 04 24 75 16 80 00 	movl   $0x801675,(%esp)
  80035d:	e8 7e 02 00 00       	call   8005e0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800372:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80037d:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800391:	54                   	push   %esp
  800392:	5d                   	pop    %ebp
  800393:	8d 35 9b 03 80 00    	lea    0x80039b,%esi
  800399:	0f 34                	sysenter 
  80039b:	5f                   	pop    %edi
  80039c:	5e                   	pop    %esi
  80039d:	5d                   	pop    %ebp
  80039e:	5c                   	pop    %esp
  ...
  8003a4:	7e 28                	jle    8003ce <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003a6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003aa:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  8003b1:	00 
  8003b2:	c7 44 24 08 58 16 80 	movl   $0x801658,0x8(%esp)
  8003b9:	00 
  8003ba:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8003c1:	00 
  8003c2:	c7 04 24 75 16 80 00 	movl   $0x801675,(%esp)
  8003c9:	e8 12 02 00 00       	call   8005e0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8003ce:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8003d1:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8003d4:	89 ec                	mov    %ebp,%esp
  8003d6:	5d                   	pop    %ebp
  8003d7:	c3                   	ret    

008003d8 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8003de:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8003e1:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8003e4:	8b 7d 18             	mov    0x18(%ebp),%edi
  8003e7:	0b 7d 14             	or     0x14(%ebp),%edi
  8003ea:	b8 06 00 00 00       	mov    $0x6,%eax
  8003ef:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8003f2:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  800412:	7e 28                	jle    80043c <sys_page_map+0x64>
		panic("syscall %d returned %d (> 0)", num, ret);
  800414:	89 44 24 10          	mov    %eax,0x10(%esp)
  800418:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80041f:	00 
  800420:	c7 44 24 08 58 16 80 	movl   $0x801658,0x8(%esp)
  800427:	00 
  800428:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80042f:	00 
  800430:	c7 04 24 75 16 80 00 	movl   $0x801675,(%esp)
  800437:	e8 a4 01 00 00       	call   8005e0 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800457:	b8 05 00 00 00       	mov    $0x5,%eax
  ...
  80047f:	7e 28                	jle    8004a9 <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  800481:	89 44 24 10          	mov    %eax,0x10(%esp)
  800485:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  80048c:	00 
  80048d:	c7 44 24 08 58 16 80 	movl   $0x801658,0x8(%esp)
  800494:	00 
  800495:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80049c:	00 
  80049d:	c7 04 24 75 16 80 00 	movl   $0x801675,(%esp)
  8004a4:	e8 37 01 00 00       	call   8005e0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8004a9:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8004ac:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004af:	89 ec                	mov    %ebp,%esp
  8004b1:	5d                   	pop    %ebp
  8004b2:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8004c5:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_yield(void)
{
  ...
  8004e8:	8b 1c 24             	mov    (%esp),%ebx
  8004eb:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8004ef:	89 ec                	mov    %ebp,%esp
  8004f1:	5d                   	pop    %ebp
  8004f2:	c3                   	ret    

008004f3 <sys_map_kernel_page>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800505:	b8 04 00 00 00       	mov    $0x4,%eax
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  80052d:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800531:	89 ec                	mov    %ebp,%esp
  800533:	5d                   	pop    %ebp
  800534:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800559:	54                   	push   %esp
  80055a:	5d                   	pop    %ebp
  80055b:	8d 35 63 05 80 00    	lea    0x800563,%esi
  800561:	0f 34                	sysenter 
  800563:	5f                   	pop    %edi
  800564:	5e                   	pop    %esi
  800565:	5d                   	pop    %ebp
  800566:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  80056a:	8b 1c 24             	mov    (%esp),%ebx
  80056d:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800571:	89 ec                	mov    %ebp,%esp
  800573:	5d                   	pop    %ebp
  800574:	c3                   	ret    

00800575 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  80057b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80057e:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800586:	b8 03 00 00 00       	mov    $0x3,%eax
  80058b:	8b 55 08             	mov    0x8(%ebp),%edx
  80058e:	89 cb                	mov    %ecx,%ebx
  ...
  800599:	54                   	push   %esp
  80059a:	5d                   	pop    %ebp
  80059b:	8d 35 a3 05 80 00    	lea    0x8005a3,%esi
  8005a1:	0f 34                	sysenter 
  8005a3:	5f                   	pop    %edi
  8005a4:	5e                   	pop    %esi
  8005a5:	5d                   	pop    %ebp
  8005a6:	5c                   	pop    %esp
  ...
  8005ac:	7e 28                	jle    8005d6 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  8005ae:	89 44 24 10          	mov    %eax,0x10(%esp)
  8005b2:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8005b9:	00 
  8005ba:	c7 44 24 08 58 16 80 	movl   $0x801658,0x8(%esp)
  8005c1:	00 
  8005c2:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8005c9:	00 
  8005ca:	c7 04 24 75 16 80 00 	movl   $0x801675,(%esp)
  8005d1:	e8 0a 00 00 00       	call   8005e0 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  8005d6:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8005d9:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8005dc:	89 ec                	mov    %ebp,%esp
  8005de:	5d                   	pop    %ebp
  8005df:	c3                   	ret    
...
void
_panic(const char *file, int line, const char *fmt, ...)
  8005e8:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
	...
	if (argv0)
  8005eb:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8005f0:	85 c0                	test   %eax,%eax
  8005f2:	74 10                	je     800604 <_panic+0x24>
		cprintf("%s: ", argv0);
  8005f4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8005f8:	c7 04 24 83 16 80 00 	movl   $0x801683,(%esp)
  8005ff:	e8 ad 00 00 00       	call   8006b1 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800604:	8b 1d 04 20 80 00    	mov    0x802004,%ebx
  80060a:	e8 26 ff ff ff       	call   800535 <sys_getenvid>
  80060f:	8b 55 0c             	mov    0xc(%ebp),%edx
  800612:	89 54 24 10          	mov    %edx,0x10(%esp)
  800616:	8b 55 08             	mov    0x8(%ebp),%edx
  800619:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80061d:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800621:	89 44 24 04          	mov    %eax,0x4(%esp)
  800625:	c7 04 24 88 16 80 00 	movl   $0x801688,(%esp)
  80062c:	e8 80 00 00 00       	call   8006b1 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800631:	89 74 24 04          	mov    %esi,0x4(%esp)
  800635:	8b 45 10             	mov    0x10(%ebp),%eax
  800638:	89 04 24             	mov    %eax,(%esp)
  80063b:	e8 10 00 00 00       	call   800650 <vcprintf>
	cprintf("\n");
  800640:	c7 04 24 4c 16 80 00 	movl   $0x80164c,(%esp)
  800647:	e8 65 00 00 00       	call   8006b1 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80064c:	cc                   	int3   
  80064d:	eb fd                	jmp    80064c <_panic+0x6c>
	...
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800653:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  80067b:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  800681:	89 44 24 04          	mov    %eax,0x4(%esp)
  800685:	c7 04 24 cb 06 80 00 	movl   $0x8006cb,(%esp)
  80068c:	e8 cb 01 00 00       	call   80085c <vprintfmt>
	sys_cputs(b.buf, b.idx);
  800691:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  800697:	89 44 24 04          	mov    %eax,0x4(%esp)
  80069b:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8006a1:	89 04 24             	mov    %eax,(%esp)
  8006a4:	e8 53 fa ff ff       	call   8000fc <sys_cputs>

	return b.cnt;
}
  8006a9:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  8006af:	c9                   	leave  
  8006b0:	c3                   	ret    
  ...
  8006b7:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  8006c4:	e8 87 ff ff ff       	call   800650 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  8006d2:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  8006d5:	8b 03                	mov    (%ebx),%eax
  8006d7:	8b 55 08             	mov    0x8(%ebp),%edx
  8006da:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  8006de:	83 c0 01             	add    $0x1,%eax
  8006e1:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  8006e3:	3d ff 00 00 00       	cmp    $0xff,%eax
  8006e8:	75 19                	jne    800703 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8006ea:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8006f1:	00 
  8006f2:	8d 43 08             	lea    0x8(%ebx),%eax
  8006f5:	89 04 24             	mov    %eax,(%esp)
  8006f8:	e8 ff f9 ff ff       	call   8000fc <sys_cputs>
		b->idx = 0;
  8006fd:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  800703:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
  800707:	83 c4 14             	add    $0x14,%esp
  80070a:	5b                   	pop    %ebx
  80070b:	5d                   	pop    %ebp
  80070c:	c3                   	ret    
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8007f0:	0f be 80 ab 16 80 00 	movsbl 0x8016ab(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8009a6:	c7 44 24 08 bc 16 80 	movl   $0x8016bc,0x8(%esp)
  8009ad:	00 
  ...
  8009cc:	c7 44 24 08 c5 16 80 	movl   $0x8016c5,0x8(%esp)
  8009d3:	00 
  ...
  800a0a:	be c8 16 80 00       	mov    $0x8016c8,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800d09:	0f be 80 ab 16 80 00 	movsbl 0x8016ab(%eax),%eax
  ...
  800db5:	c7 44 24 0c 64 17 80 	movl   $0x801764,0xc(%esp)
  800dbc:	00 
  800dbd:	c7 44 24 08 c5 16 80 	movl   $0x8016c5,0x8(%esp)
  800dc4:	00 
  ...
  800deb:	c7 44 24 0c 9c 17 80 	movl   $0x80179c,0xc(%esp)
  800df2:	00 
  800df3:	c7 44 24 08 c5 16 80 	movl   $0x8016c5,0x8(%esp)
  800dfa:	00 
  ...
  800e88:	0f be 80 ab 16 80 00 	movsbl 0x8016ab(%eax),%eax
  ...
  800eca:	0f be 80 ab 16 80 00 	movsbl 0x8016ab(%eax),%eax
