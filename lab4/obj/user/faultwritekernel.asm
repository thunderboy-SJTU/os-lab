...
libmain(int argc, char **argv)
{
  ...
  800056:	e8 ca 04 00 00       	call   800525 <sys_getenvid>
...
exit(void)
{
  ...
  8000a5:	e8 bb 04 00 00       	call   800565 <sys_env_destroy>
}
  8000aa:	c9                   	leave  
  8000ab:	c3                   	ret    
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  800131:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800134:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800163:	7e 28                	jle    80018d <sys_env_set_prior+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800165:	89 44 24 10          	mov    %eax,0x10(%esp)
  800169:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  800170:	00 
  800171:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  800178:	00 
  800179:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800180:	00 
  800181:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  800188:	e8 43 04 00 00       	call   8005d0 <_panic>
}
...
sys_sbrk(uint32_t inc)
{
  ...
  8001a0:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001a9:	b8 0f 00 00 00       	mov    $0xf,%eax
...
sys_sbrk(uint32_t inc)
{
  ...
  8001d0:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8001d4:	89 ec                	mov    %ebp,%esp
  8001d6:	5d                   	pop    %ebp
  8001d7:	c3                   	ret    

008001d8 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  8001db:	83 ec 28             	sub    $0x28,%esp
  8001de:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8001e4:	b9 00 00 00 00       	mov    $0x0,%ecx
  8001e9:	b8 0d 00 00 00       	mov    $0xd,%eax
  8001ee:	8b 55 08             	mov    0x8(%ebp),%edx
  8001f1:	89 cb                	mov    %ecx,%ebx
  8001f3:	89 cf                	mov    %ecx,%edi
  8001f5:	51                   	push   %ecx
  8001f6:	52                   	push   %edx
  8001f7:	53                   	push   %ebx
  8001f8:	54                   	push   %esp
  ...
  80020f:	7e 28                	jle    800239 <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800211:	89 44 24 10          	mov    %eax,0x10(%esp)
  800215:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  80021c:	00 
  80021d:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  800224:	00 
  800225:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80022c:	00 
  80022d:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  800234:	e8 97 03 00 00       	call   8005d0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800239:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80023c:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80023f:	89 ec                	mov    %ebp,%esp
  800241:	5d                   	pop    %ebp
  800242:	c3                   	ret    

00800243 <sys_ipc_try_send>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800250:	b8 0c 00 00 00       	mov    $0xc,%eax
  800255:	8b 7d 14             	mov    0x14(%ebp),%edi
  800258:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  800268:	54                   	push   %esp
  800269:	5d                   	pop    %ebp
  80026a:	8d 35 72 02 80 00    	lea    0x800272,%esi
  800270:	0f 34                	sysenter 
  800272:	5f                   	pop    %edi
  800273:	5e                   	pop    %esi
  800274:	5d                   	pop    %ebp
  800275:	5c                   	pop    %esp
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800279:	8b 1c 24             	mov    (%esp),%ebx
  80027c:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800280:	89 ec                	mov    %ebp,%esp
  800282:	5d                   	pop    %ebp
  800283:	c3                   	ret    

00800284 <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80028a:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800295:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  8002bc:	7e 28                	jle    8002e6 <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002be:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002c2:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  8002c9:	00 
  8002ca:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  8002d1:	00 
  8002d2:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8002d9:	00 
  8002da:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  8002e1:	e8 ea 02 00 00       	call   8005d0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e6:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8002e9:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002ec:	89 ec                	mov    %ebp,%esp
  8002ee:	5d                   	pop    %ebp
  8002ef:	c3                   	ret    
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002f6:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800315:	54                   	push   %esp
  800316:	5d                   	pop    %ebp
  800317:	8d 35 1f 03 80 00    	lea    0x80031f,%esi
  80031d:	0f 34                	sysenter 
  80031f:	5f                   	pop    %edi
  800320:	5e                   	pop    %esi
  800321:	5d                   	pop    %ebp
  800322:	5c                   	pop    %esp
  ...
  800328:	7e 28                	jle    800352 <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80032a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80032e:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800335:	00 
  800336:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  80033d:	00 
  80033e:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800345:	00 
  800346:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  80034d:	e8 7e 02 00 00       	call   8005d0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800362:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80036d:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800381:	54                   	push   %esp
  800382:	5d                   	pop    %ebp
  800383:	8d 35 8b 03 80 00    	lea    0x80038b,%esi
  800389:	0f 34                	sysenter 
  80038b:	5f                   	pop    %edi
  80038c:	5e                   	pop    %esi
  80038d:	5d                   	pop    %ebp
  80038e:	5c                   	pop    %esp
  ...
  800394:	7e 28                	jle    8003be <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800396:	89 44 24 10          	mov    %eax,0x10(%esp)
  80039a:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  8003a1:	00 
  8003a2:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  8003a9:	00 
  8003aa:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8003b1:	00 
  8003b2:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  8003b9:	e8 12 02 00 00       	call   8005d0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8003be:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8003c1:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8003c4:	89 ec                	mov    %ebp,%esp
  8003c6:	5d                   	pop    %ebp
  8003c7:	c3                   	ret    

008003c8 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8003ce:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8003d1:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800402:	7e 28                	jle    80042c <sys_page_map+0x64>
		panic("syscall %d returned %d (> 0)", num, ret);
  800404:	89 44 24 10          	mov    %eax,0x10(%esp)
  800408:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80040f:	00 
  800410:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  800417:	00 
  800418:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80041f:	00 
  800420:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  800427:	e8 a4 01 00 00       	call   8005d0 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800447:	b8 05 00 00 00       	mov    $0x5,%eax
  ...
  80046f:	7e 28                	jle    800499 <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  800471:	89 44 24 10          	mov    %eax,0x10(%esp)
  800475:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  80047c:	00 
  80047d:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  800484:	00 
  800485:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80048c:	00 
  80048d:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  800494:	e8 37 01 00 00       	call   8005d0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800499:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80049c:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80049f:	89 ec                	mov    %ebp,%esp
  8004a1:	5d                   	pop    %ebp
  8004a2:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8004b5:	b8 0b 00 00 00       	mov    $0xb,%eax
...
sys_yield(void)
{
  ...
  8004d8:	8b 1c 24             	mov    (%esp),%ebx
  8004db:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8004df:	89 ec                	mov    %ebp,%esp
  8004e1:	5d                   	pop    %ebp
  8004e2:	c3                   	ret    

008004e3 <sys_map_kernel_page>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8004f0:	bb 00 00 00 00       	mov    $0x0,%ebx
  8004f5:	b8 04 00 00 00       	mov    $0x4,%eax
  8004fa:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  80051d:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800521:	89 ec                	mov    %ebp,%esp
  800523:	5d                   	pop    %ebp
  800524:	c3                   	ret    

00800525 <sys_getenvid>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800549:	54                   	push   %esp
  80054a:	5d                   	pop    %ebp
  80054b:	8d 35 53 05 80 00    	lea    0x800553,%esi
  800551:	0f 34                	sysenter 
  800553:	5f                   	pop    %edi
  800554:	5e                   	pop    %esi
  800555:	5d                   	pop    %ebp
  800556:	5c                   	pop    %esp
...
sys_env_destroy(envid_t envid)
{
  ...
  80056b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80056e:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800576:	b8 03 00 00 00       	mov    $0x3,%eax
  80057b:	8b 55 08             	mov    0x8(%ebp),%edx
  80057e:	89 cb                	mov    %ecx,%ebx
  ...
  800589:	54                   	push   %esp
  80058a:	5d                   	pop    %ebp
  80058b:	8d 35 93 05 80 00    	lea    0x800593,%esi
  800591:	0f 34                	sysenter 
  800593:	5f                   	pop    %edi
  800594:	5e                   	pop    %esi
  800595:	5d                   	pop    %ebp
  800596:	5c                   	pop    %esp
  ...
  80059c:	7e 28                	jle    8005c6 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  80059e:	89 44 24 10          	mov    %eax,0x10(%esp)
  8005a2:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8005a9:	00 
  8005aa:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  8005b1:	00 
  8005b2:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8005b9:	00 
  8005ba:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  8005c1:	e8 0a 00 00 00       	call   8005d0 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  8005c6:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8005c9:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8005cc:	89 ec                	mov    %ebp,%esp
  8005ce:	5d                   	pop    %ebp
  8005cf:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
  8005d8:	8d 75 14             	lea    0x14(%ebp),%esi
	...
	if (argv0)
  8005db:	a1 08 20 80 00       	mov    0x802008,%eax
  8005e0:	85 c0                	test   %eax,%eax
  8005e2:	74 10                	je     8005f4 <_panic+0x24>
		cprintf("%s: ", argv0);
  8005e4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8005e8:	c7 04 24 75 16 80 00 	movl   $0x801675,(%esp)
  8005ef:	e8 ad 00 00 00       	call   8006a1 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8005f4:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  8005fa:	e8 26 ff ff ff       	call   800525 <sys_getenvid>
  8005ff:	8b 55 0c             	mov    0xc(%ebp),%edx
  800602:	89 54 24 10          	mov    %edx,0x10(%esp)
  800606:	8b 55 08             	mov    0x8(%ebp),%edx
  800609:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80060d:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800611:	89 44 24 04          	mov    %eax,0x4(%esp)
  800615:	c7 04 24 7c 16 80 00 	movl   $0x80167c,(%esp)
  80061c:	e8 80 00 00 00       	call   8006a1 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800621:	89 74 24 04          	mov    %esi,0x4(%esp)
  800625:	8b 45 10             	mov    0x10(%ebp),%eax
  800628:	89 04 24             	mov    %eax,(%esp)
  80062b:	e8 10 00 00 00       	call   800640 <vcprintf>
	cprintf("\n");
  800630:	c7 04 24 7a 16 80 00 	movl   $0x80167a,(%esp)
  800637:	e8 65 00 00 00       	call   8006a1 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80063c:	cc                   	int3   
  80063d:	eb fd                	jmp    80063c <_panic+0x6c>
	...
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800643:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;

	b.idx = 0;
  800649:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  800650:	00 00 00 
	b.cnt = 0;
  800653:	c7 85 f4 fe ff ff 00 	movl   $0x0,-0x10c(%ebp)
  80065a:	00 00 00 
	vprintfmt((void*)putch, &b, fmt, ap);
  80065d:	8b 45 0c             	mov    0xc(%ebp),%eax
  800660:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800664:	8b 45 08             	mov    0x8(%ebp),%eax
  800667:	89 44 24 08          	mov    %eax,0x8(%esp)
  80066b:	8d 85 f0 fe ff ff    	lea    -0x110(%ebp),%eax
  800671:	89 44 24 04          	mov    %eax,0x4(%esp)
  800675:	c7 04 24 bb 06 80 00 	movl   $0x8006bb,(%esp)
  80067c:	e8 cb 01 00 00       	call   80084c <vprintfmt>
	sys_cputs(b.buf, b.idx);
  800681:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  800687:	89 44 24 04          	mov    %eax,0x4(%esp)
  80068b:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  800691:	89 04 24             	mov    %eax,(%esp)
  800694:	e8 53 fa ff ff       	call   8000ec <sys_cputs>

	return b.cnt;
}
  800699:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  80069f:	c9                   	leave  
  8006a0:	c3                   	ret    
  ...
  8006a7:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  8006b4:	e8 87 ff ff ff       	call   800640 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  8006be:	53                   	push   %ebx
  8006bf:	83 ec 14             	sub    $0x14,%esp
  8006c2:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  8006c5:	8b 03                	mov    (%ebx),%eax
  8006c7:	8b 55 08             	mov    0x8(%ebp),%edx
  8006ca:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  8006ce:	83 c0 01             	add    $0x1,%eax
  8006d1:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  8006d3:	3d ff 00 00 00       	cmp    $0xff,%eax
  8006d8:	75 19                	jne    8006f3 <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8006da:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8006e1:	00 
  8006e2:	8d 43 08             	lea    0x8(%ebx),%eax
  8006e5:	89 04 24             	mov    %eax,(%esp)
  8006e8:	e8 ff f9 ff ff       	call   8000ec <sys_cputs>
		b->idx = 0;
  8006ed:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  8006f3:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
  8006f7:	83 c4 14             	add    $0x14,%esp
  8006fa:	5b                   	pop    %ebx
  8006fb:	5d                   	pop    %ebp
  8006fc:	c3                   	ret    
