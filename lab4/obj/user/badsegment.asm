...
libmain(int argc, char **argv)
{
  ...
  800052:	e8 ca 04 00 00       	call   800521 <sys_getenvid>
...
exit(void)
{
  ...
  8000a1:	e8 bb 04 00 00       	call   800561 <sys_env_destroy>
}
  8000a6:	c9                   	leave  
  8000a7:	c3                   	ret    
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  80012a:	83 ec 28             	sub    $0x28,%esp
  80012d:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800130:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800133:	bb 00 00 00 00       	mov    $0x0,%ebx
  800138:	b8 0e 00 00 00       	mov    $0xe,%eax
  80013d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800140:	8b 55 08             	mov    0x8(%ebp),%edx
  800143:	89 df                	mov    %ebx,%edi
  800145:	51                   	push   %ecx
  800146:	52                   	push   %edx
  800147:	53                   	push   %ebx
  800148:	54                   	push   %esp
  ...
  80015f:	7e 28                	jle    800189 <sys_env_set_prior+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800161:	89 44 24 10          	mov    %eax,0x10(%esp)
  800165:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  80016c:	00 
  80016d:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  800174:	00 
  800175:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80017c:	00 
  80017d:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  800184:	e8 43 04 00 00       	call   8005cc <_panic>
}
...
sys_sbrk(uint32_t inc)
{
  ...
  80019c:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001ad:	89 cb                	mov    %ecx,%ebx
  8001af:	89 cf                	mov    %ecx,%edi
  8001b1:	51                   	push   %ecx
  8001b2:	52                   	push   %edx
  8001b3:	53                   	push   %ebx
  8001b4:	54                   	push   %esp
  ...
  8001b8:	54                   	push   %esp
  8001b9:	5d                   	pop    %ebp
  8001ba:	8d 35 c2 01 80 00    	lea    0x8001c2,%esi
...
sys_sbrk(uint32_t inc)
{
  ...
  8001cc:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8001d0:	89 ec                	mov    %ebp,%esp
  8001d2:	5d                   	pop    %ebp
  8001d3:	c3                   	ret    

008001d4 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  8001da:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8001dd:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001e5:	b8 0d 00 00 00       	mov    $0xd,%eax
  8001ea:	8b 55 08             	mov    0x8(%ebp),%edx
  8001ed:	89 cb                	mov    %ecx,%ebx
  8001ef:	89 cf                	mov    %ecx,%edi
  8001f1:	51                   	push   %ecx
  8001f2:	52                   	push   %edx
  8001f3:	53                   	push   %ebx
  8001f4:	54                   	push   %esp
  ...
  80020b:	7e 28                	jle    800235 <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  80020d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800211:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  800218:	00 
  800219:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  800220:	00 
  800221:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800228:	00 
  800229:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  800230:	e8 97 03 00 00       	call   8005cc <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  80024c:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  800264:	54                   	push   %esp
  800265:	5d                   	pop    %ebp
  800266:	8d 35 6e 02 80 00    	lea    0x80026e,%esi
  80026c:	0f 34                	sysenter 
  80026e:	5f                   	pop    %edi
  80026f:	5e                   	pop    %esi
  800270:	5d                   	pop    %ebp
  800271:	5c                   	pop    %esp
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800275:	8b 1c 24             	mov    (%esp),%ebx
  800278:	8b 7c 24 04          	mov    0x4(%esp),%edi
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800291:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  8002b8:	7e 28                	jle    8002e2 <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002ba:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002be:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  8002c5:	00 
  8002c6:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  8002cd:	00 
  8002ce:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8002d5:	00 
  8002d6:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  8002dd:	e8 ea 02 00 00       	call   8005cc <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800324:	7e 28                	jle    80034e <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800326:	89 44 24 10          	mov    %eax,0x10(%esp)
  80032a:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  800331:	00 
  800332:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  800339:	00 
  80033a:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800341:	00 
  800342:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  800349:	e8 7e 02 00 00       	call   8005cc <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800369:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  80037d:	54                   	push   %esp
  80037e:	5d                   	pop    %ebp
  80037f:	8d 35 87 03 80 00    	lea    0x800387,%esi
  800385:	0f 34                	sysenter 
  800387:	5f                   	pop    %edi
  800388:	5e                   	pop    %esi
  800389:	5d                   	pop    %ebp
  80038a:	5c                   	pop    %esp
  ...
  800390:	7e 28                	jle    8003ba <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800392:	89 44 24 10          	mov    %eax,0x10(%esp)
  800396:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  80039d:	00 
  80039e:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  8003a5:	00 
  8003a6:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8003ad:	00 
  8003ae:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  8003b5:	e8 12 02 00 00       	call   8005cc <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8003ba:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8003bd:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8003c0:	89 ec                	mov    %ebp,%esp
  8003c2:	5d                   	pop    %ebp
  8003c3:	c3                   	ret    
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8003ca:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8003d3:	0b 7d 14             	or     0x14(%ebp),%edi
  8003d6:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  8003eb:	54                   	push   %esp
  8003ec:	5d                   	pop    %ebp
  8003ed:	8d 35 f5 03 80 00    	lea    0x8003f5,%esi
  8003f3:	0f 34                	sysenter 
  8003f5:	5f                   	pop    %edi
  8003f6:	5e                   	pop    %esi
  8003f7:	5d                   	pop    %ebp
  8003f8:	5c                   	pop    %esp
  ...
  8003fe:	7e 28                	jle    800428 <sys_page_map+0x64>
		panic("syscall %d returned %d (> 0)", num, ret);
  800400:	89 44 24 10          	mov    %eax,0x10(%esp)
  800404:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80040b:	00 
  80040c:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  800413:	00 
  800414:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80041b:	00 
  80041c:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  800423:	e8 a4 01 00 00       	call   8005cc <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800428:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80042b:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80042e:	89 ec                	mov    %ebp,%esp
  800430:	5d                   	pop    %ebp
  800431:	c3                   	ret    

00800432 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800438:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800443:	b8 05 00 00 00       	mov    $0x5,%eax
  ...
  800458:	54                   	push   %esp
  800459:	5d                   	pop    %ebp
  80045a:	8d 35 62 04 80 00    	lea    0x800462,%esi
  800460:	0f 34                	sysenter 
  800462:	5f                   	pop    %edi
  800463:	5e                   	pop    %esi
  800464:	5d                   	pop    %ebp
  800465:	5c                   	pop    %esp
  ...
  80046b:	7e 28                	jle    800495 <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  80046d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800471:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800478:	00 
  800479:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  800480:	00 
  800481:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800488:	00 
  800489:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  800490:	e8 37 01 00 00       	call   8005cc <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800495:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800498:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80049b:	89 ec                	mov    %ebp,%esp
  80049d:	5d                   	pop    %ebp
  80049e:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8004b1:	b8 0b 00 00 00       	mov    $0xb,%eax
  ...
  8004c3:	54                   	push   %esp
  8004c4:	5d                   	pop    %ebp
  8004c5:	8d 35 cd 04 80 00    	lea    0x8004cd,%esi
  8004cb:	0f 34                	sysenter 
  8004cd:	5f                   	pop    %edi
  8004ce:	5e                   	pop    %esi
  8004cf:	5d                   	pop    %ebp
  8004d0:	5c                   	pop    %esp
...
sys_yield(void)
{
  ...
  8004d4:	8b 1c 24             	mov    (%esp),%ebx
  8004d7:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8004db:	89 ec                	mov    %ebp,%esp
  8004dd:	5d                   	pop    %ebp
  8004de:	c3                   	ret    

008004df <sys_map_kernel_page>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8004ec:	bb 00 00 00 00       	mov    $0x0,%ebx
  8004f1:	b8 04 00 00 00       	mov    $0x4,%eax
  ...
  800505:	54                   	push   %esp
  800506:	5d                   	pop    %ebp
  800507:	8d 35 0f 05 80 00    	lea    0x80050f,%esi
  80050d:	0f 34                	sysenter 
  80050f:	5f                   	pop    %edi
  800510:	5e                   	pop    %esi
  800511:	5d                   	pop    %ebp
  800512:	5c                   	pop    %esp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  800516:	8b 1c 24             	mov    (%esp),%ebx
  800519:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80051d:	89 ec                	mov    %ebp,%esp
  80051f:	5d                   	pop    %ebp
  800520:	c3                   	ret    

00800521 <sys_getenvid>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800533:	b8 02 00 00 00       	mov    $0x2,%eax
...
sys_getenvid(void)
{
  ...
  800559:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80055d:	89 ec                	mov    %ebp,%esp
  80055f:	5d                   	pop    %ebp
  800560:	c3                   	ret    

00800561 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  800564:	83 ec 28             	sub    $0x28,%esp
  800567:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80056a:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800572:	b8 03 00 00 00       	mov    $0x3,%eax
  800577:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  800585:	54                   	push   %esp
  800586:	5d                   	pop    %ebp
  800587:	8d 35 8f 05 80 00    	lea    0x80058f,%esi
  80058d:	0f 34                	sysenter 
  80058f:	5f                   	pop    %edi
  800590:	5e                   	pop    %esi
  800591:	5d                   	pop    %ebp
  800592:	5c                   	pop    %esp
  ...
  800598:	7e 28                	jle    8005c2 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  80059a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80059e:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8005a5:	00 
  8005a6:	c7 44 24 08 4a 16 80 	movl   $0x80164a,0x8(%esp)
  8005ad:	00 
  8005ae:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8005b5:	00 
  8005b6:	c7 04 24 67 16 80 00 	movl   $0x801667,(%esp)
  8005bd:	e8 0a 00 00 00       	call   8005cc <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  8005c2:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8005c5:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
void
_panic(const char *file, int line, const char *fmt, ...)
  8005d4:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
	...
	if (argv0)
  8005d7:	a1 08 20 80 00       	mov    0x802008,%eax
  8005dc:	85 c0                	test   %eax,%eax
  8005de:	74 10                	je     8005f0 <_panic+0x24>
		cprintf("%s: ", argv0);
  8005e0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8005e4:	c7 04 24 75 16 80 00 	movl   $0x801675,(%esp)
  8005eb:	e8 ad 00 00 00       	call   80069d <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8005f0:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  8005f6:	e8 26 ff ff ff       	call   800521 <sys_getenvid>
  8005fb:	8b 55 0c             	mov    0xc(%ebp),%edx
  8005fe:	89 54 24 10          	mov    %edx,0x10(%esp)
  800602:	8b 55 08             	mov    0x8(%ebp),%edx
  800605:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800609:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80060d:	89 44 24 04          	mov    %eax,0x4(%esp)
  800611:	c7 04 24 7c 16 80 00 	movl   $0x80167c,(%esp)
  800618:	e8 80 00 00 00       	call   80069d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  80061d:	89 74 24 04          	mov    %esi,0x4(%esp)
  800621:	8b 45 10             	mov    0x10(%ebp),%eax
  800624:	89 04 24             	mov    %eax,(%esp)
  800627:	e8 10 00 00 00       	call   80063c <vcprintf>
	cprintf("\n");
  80062c:	c7 04 24 7a 16 80 00 	movl   $0x80167a,(%esp)
  800633:	e8 65 00 00 00       	call   80069d <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800638:	cc                   	int3   
  800639:	eb fd                	jmp    800638 <_panic+0x6c>
	...
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  80063f:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;

	b.idx = 0;
  800645:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  80064c:	00 00 00 
	b.cnt = 0;
  80064f:	c7 85 f4 fe ff ff 00 	movl   $0x0,-0x10c(%ebp)
  800656:	00 00 00 
  ...
  800671:	c7 04 24 b7 06 80 00 	movl   $0x8006b7,(%esp)
  800678:	e8 cf 01 00 00       	call   80084c <vprintfmt>
	sys_cputs(b.buf, b.idx);
  80067d:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  800683:	89 44 24 04          	mov    %eax,0x4(%esp)
  800687:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  80068d:	89 04 24             	mov    %eax,(%esp)
  800690:	e8 53 fa ff ff       	call   8000e8 <sys_cputs>
  ...
  8006a3:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  8006b0:	e8 87 ff ff ff       	call   80063c <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  8006ba:	53                   	push   %ebx
  8006bb:	83 ec 14             	sub    $0x14,%esp
  8006be:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  8006c1:	8b 03                	mov    (%ebx),%eax
  8006c3:	8b 55 08             	mov    0x8(%ebp),%edx
  8006c6:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  8006ca:	83 c0 01             	add    $0x1,%eax
  8006cd:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  8006cf:	3d ff 00 00 00       	cmp    $0xff,%eax
  8006d4:	75 19                	jne    8006ef <putch+0x38>
		sys_cputs(b->buf, b->idx);
  8006d6:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8006dd:	00 
  8006de:	8d 43 08             	lea    0x8(%ebx),%eax
  8006e1:	89 04 24             	mov    %eax,(%esp)
  8006e4:	e8 ff f9 ff ff       	call   8000e8 <sys_cputs>
		b->idx = 0;
  8006e9:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  8006ef:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
  8006f3:	83 c4 14             	add    $0x14,%esp
  8006f6:	5b                   	pop    %ebx
  8006f7:	5d                   	pop    %ebp
  8006f8:	c3                   	ret    
  8006f9:	00 00                	add    %al,(%eax)
  8006fb:	00 00                	add    %al,(%eax)
