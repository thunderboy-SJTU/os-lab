...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 30 80 00 e0 	movl   $0x8020e0,0x803000
  800041:	20 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 17 05 00 00       	call   800560 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  80005e:	e8 7f 05 00 00       	call   8005e2 <sys_getenvid>
...
exit(void)
{
  ...
  8000a3:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a6:	e8 c0 0a 00 00       	call   800b6b <close_all>
	sys_env_destroy(0);
  8000ab:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000b2:	e8 6b 05 00 00       	call   800622 <sys_env_destroy>
}
  8000b7:	c9                   	leave  
  8000b8:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800148:	b8 10 00 00 00       	mov    $0x10,%eax
  80014d:	8b 7d 14             	mov    0x14(%ebp),%edi
  800150:	8b 5d 10             	mov    0x10(%ebp),%ebx
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  800185:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80018d:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  8001b4:	7e 28                	jle    8001de <sys_env_set_prior+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001b6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001ba:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  8001c1:	00 
  8001c2:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  8001c9:	00 
  8001ca:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8001d1:	00 
  8001d2:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  8001d9:	e8 76 0d 00 00       	call   800f54 <_panic>
}
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  8001de:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001fa:	b8 11 00 00 00       	mov    $0x11,%eax
  8001ff:	8b 55 08             	mov    0x8(%ebp),%edx
  800202:	89 cb                	mov    %ecx,%ebx
  800204:	89 cf                	mov    %ecx,%edi
  800206:	51                   	push   %ecx
  800207:	52                   	push   %edx
  800208:	53                   	push   %ebx
  800209:	54                   	push   %esp
  ...
  80020d:	54                   	push   %esp
  80020e:	5d                   	pop    %ebp
  80020f:	8d 35 17 02 80 00    	lea    0x800217,%esi
  800215:	0f 34                	sysenter 
  800217:	5f                   	pop    %edi
  800218:	5e                   	pop    %esi
  800219:	5d                   	pop    %ebp
  80021a:	5c                   	pop    %esp
...
sys_sbrk(uint32_t inc)
{
  ...
  80021e:	8b 1c 24             	mov    (%esp),%ebx
  800221:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800225:	89 ec                	mov    %ebp,%esp
  800227:	5d                   	pop    %ebp
  800228:	c3                   	ret    

00800229 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  80022f:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800232:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80023a:	b8 0e 00 00 00       	mov    $0xe,%eax
  ...
  80024d:	54                   	push   %esp
  80024e:	5d                   	pop    %ebp
  80024f:	8d 35 57 02 80 00    	lea    0x800257,%esi
  800255:	0f 34                	sysenter 
  800257:	5f                   	pop    %edi
  800258:	5e                   	pop    %esi
  800259:	5d                   	pop    %ebp
  80025a:	5c                   	pop    %esp
  ...
  800260:	7e 28                	jle    80028a <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800262:	89 44 24 10          	mov    %eax,0x10(%esp)
  800266:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  80026d:	00 
  80026e:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  800275:	00 
  800276:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80027d:	00 
  80027e:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  800285:	e8 ca 0c 00 00       	call   800f54 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80028a:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002a9:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  8002b9:	54                   	push   %esp
  8002ba:	5d                   	pop    %ebp
  8002bb:	8d 35 c3 02 80 00    	lea    0x8002c3,%esi
  8002c1:	0f 34                	sysenter 
  8002c3:	5f                   	pop    %edi
  8002c4:	5e                   	pop    %esi
  8002c5:	5d                   	pop    %ebp
  8002c6:	5c                   	pop    %esp
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8002ca:	8b 1c 24             	mov    (%esp),%ebx
  8002cd:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8002d1:	89 ec                	mov    %ebp,%esp
  8002d3:	5d                   	pop    %ebp
  8002d4:	c3                   	ret    
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002db:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80030d:	7e 28                	jle    800337 <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80030f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800313:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  80031a:	00 
  80031b:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  800322:	00 
  800323:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80032a:	00 
  80032b:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  800332:	e8 1d 0c 00 00       	call   800f54 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800337:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800344:	83 ec 28             	sub    $0x28,%esp
  800347:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80034a:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800366:	54                   	push   %esp
  800367:	5d                   	pop    %ebp
  800368:	8d 35 70 03 80 00    	lea    0x800370,%esi
  80036e:	0f 34                	sysenter 
  800370:	5f                   	pop    %edi
  800371:	5e                   	pop    %esi
  800372:	5d                   	pop    %ebp
  800373:	5c                   	pop    %esp
  ...
  800379:	7e 28                	jle    8003a3 <sys_env_set_trapframe+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80037b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80037f:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800386:	00 
  800387:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  80038e:	00 
  80038f:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800396:	00 
  800397:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  80039e:	e8 b1 0b 00 00       	call   800f54 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8003a3:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8003a6:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8003a9:	89 ec                	mov    %ebp,%esp
  8003ab:	5d                   	pop    %ebp
  8003ac:	c3                   	ret    

008003ad <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8003b3:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8003be:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8003d2:	54                   	push   %esp
  8003d3:	5d                   	pop    %ebp
  8003d4:	8d 35 dc 03 80 00    	lea    0x8003dc,%esi
  8003da:	0f 34                	sysenter 
  8003dc:	5f                   	pop    %edi
  8003dd:	5e                   	pop    %esi
  8003de:	5d                   	pop    %ebp
  8003df:	5c                   	pop    %esp
  ...
  8003e5:	7e 28                	jle    80040f <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003e7:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003eb:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8003f2:	00 
  8003f3:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  8003fa:	00 
  8003fb:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800402:	00 
  800403:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  80040a:	e8 45 0b 00 00       	call   800f54 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80041c:	83 ec 28             	sub    $0x28,%esp
  80041f:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800422:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80042a:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  80043e:	54                   	push   %esp
  80043f:	5d                   	pop    %ebp
  800440:	8d 35 48 04 80 00    	lea    0x800448,%esi
  800446:	0f 34                	sysenter 
  800448:	5f                   	pop    %edi
  800449:	5e                   	pop    %esi
  80044a:	5d                   	pop    %ebp
  80044b:	5c                   	pop    %esp
  ...
  800451:	7e 28                	jle    80047b <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800453:	89 44 24 10          	mov    %eax,0x10(%esp)
  800457:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  80045e:	00 
  80045f:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  800466:	00 
  800467:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80046e:	00 
  80046f:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  800476:	e8 d9 0a 00 00       	call   800f54 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80047b:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80047e:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800481:	89 ec                	mov    %ebp,%esp
  800483:	5d                   	pop    %ebp
  800484:	c3                   	ret    

00800485 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800488:	83 ec 28             	sub    $0x28,%esp
  80048b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800491:	8b 7d 18             	mov    0x18(%ebp),%edi
  800494:	0b 7d 14             	or     0x14(%ebp),%edi
  800497:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  8004ac:	54                   	push   %esp
  8004ad:	5d                   	pop    %ebp
  8004ae:	8d 35 b6 04 80 00    	lea    0x8004b6,%esi
  8004b4:	0f 34                	sysenter 
  8004b6:	5f                   	pop    %edi
  8004b7:	5e                   	pop    %esi
  8004b8:	5d                   	pop    %ebp
  8004b9:	5c                   	pop    %esp
  ...
  8004bf:	7e 28                	jle    8004e9 <sys_page_map+0x64>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004c1:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004c5:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  8004cc:	00 
  8004cd:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  8004d4:	00 
  8004d5:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8004dc:	00 
  8004dd:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  8004e4:	e8 6b 0a 00 00       	call   800f54 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8004e9:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8004ec:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004ef:	89 ec                	mov    %ebp,%esp
  8004f1:	5d                   	pop    %ebp
  8004f2:	c3                   	ret    

008004f3 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8004f9:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8004fc:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8004ff:	bf 00 00 00 00       	mov    $0x0,%edi
  800504:	b8 05 00 00 00       	mov    $0x5,%eax
  800509:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80050c:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  800519:	54                   	push   %esp
  80051a:	5d                   	pop    %ebp
  80051b:	8d 35 23 05 80 00    	lea    0x800523,%esi
  800521:	0f 34                	sysenter 
  800523:	5f                   	pop    %edi
  800524:	5e                   	pop    %esi
  800525:	5d                   	pop    %ebp
  800526:	5c                   	pop    %esp
  ...
  80052c:	7e 28                	jle    800556 <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  80052e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800532:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800539:	00 
  80053a:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  800541:	00 
  800542:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800549:	00 
  80054a:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  800551:	e8 fe 09 00 00       	call   800f54 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800556:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800559:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80055c:	89 ec                	mov    %ebp,%esp
  80055e:	5d                   	pop    %ebp
  80055f:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800572:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  800584:	54                   	push   %esp
  800585:	5d                   	pop    %ebp
  800586:	8d 35 8e 05 80 00    	lea    0x80058e,%esi
  80058c:	0f 34                	sysenter 
  80058e:	5f                   	pop    %edi
  80058f:	5e                   	pop    %esi
  800590:	5d                   	pop    %ebp
  800591:	5c                   	pop    %esp
...
sys_yield(void)
{
  ...
  800595:	8b 1c 24             	mov    (%esp),%ebx
  800598:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80059c:	89 ec                	mov    %ebp,%esp
  80059e:	5d                   	pop    %ebp
  80059f:	c3                   	ret    

008005a0 <sys_map_kernel_page>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8005b2:	b8 04 00 00 00       	mov    $0x4,%eax
  ...
  8005c6:	54                   	push   %esp
  8005c7:	5d                   	pop    %ebp
  8005c8:	8d 35 d0 05 80 00    	lea    0x8005d0,%esi
  8005ce:	0f 34                	sysenter 
  8005d0:	5f                   	pop    %edi
  8005d1:	5e                   	pop    %esi
  8005d2:	5d                   	pop    %ebp
  8005d3:	5c                   	pop    %esp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  8005d7:	8b 1c 24             	mov    (%esp),%ebx
  8005da:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8005de:	89 ec                	mov    %ebp,%esp
  8005e0:	5d                   	pop    %ebp
  8005e1:	c3                   	ret    

008005e2 <sys_getenvid>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8005f4:	b8 02 00 00 00       	mov    $0x2,%eax
  8005f9:	89 d1                	mov    %edx,%ecx
  ...
  800606:	54                   	push   %esp
  800607:	5d                   	pop    %ebp
  800608:	8d 35 10 06 80 00    	lea    0x800610,%esi
  80060e:	0f 34                	sysenter 
  800610:	5f                   	pop    %edi
  800611:	5e                   	pop    %esi
  800612:	5d                   	pop    %ebp
  800613:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  800617:	8b 1c 24             	mov    (%esp),%ebx
  80061a:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80061e:	89 ec                	mov    %ebp,%esp
  800620:	5d                   	pop    %ebp
  800621:	c3                   	ret    

00800622 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  800625:	83 ec 28             	sub    $0x28,%esp
  800628:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80062b:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800633:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  800646:	54                   	push   %esp
  800647:	5d                   	pop    %ebp
  800648:	8d 35 50 06 80 00    	lea    0x800650,%esi
  80064e:	0f 34                	sysenter 
  800650:	5f                   	pop    %edi
  800651:	5e                   	pop    %esi
  800652:	5d                   	pop    %ebp
  800653:	5c                   	pop    %esp
  ...
  800659:	7e 28                	jle    800683 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  80065b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80065f:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800666:	00 
  800667:	c7 44 24 08 ef 20 80 	movl   $0x8020ef,0x8(%esp)
  80066e:	00 
  80066f:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800676:	00 
  800677:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  80067e:	e8 d1 08 00 00       	call   800f54 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800683:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  8007b9:	be 98 21 80 00       	mov    $0x802198,%esi
		if (devtab[i]->dev_id == dev_id) {
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8007ec:	c7 04 24 1c 21 80 00 	movl   $0x80211c,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008d1:	c7 04 24 3c 21 80 00 	movl   $0x80213c,(%esp)
  ...
  800931:	e8 6b fe ff ff       	call   8007a1 <dev_lookup>
{
  ...
  800953:	c7 04 24 5d 21 80 00 	movl   $0x80215d,(%esp)
  ...
  8009ba:	e8 e2 fd ff ff       	call   8007a1 <dev_lookup>
{
  ...
  8009e1:	c7 04 24 7a 21 80 00 	movl   $0x80217a,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800ae0:	e8 34 f9 ff ff       	call   800419 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800c2e:	e8 52 f8 ff ff       	call   800485 <sys_page_map>
  ...
  800c69:	e8 17 f8 ff ff       	call   800485 <sys_page_map>
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800f65:	e8 78 f6 ff ff       	call   8005e2 <sys_getenvid>
  ...
  800f80:	c7 04 24 a0 21 80 00 	movl   $0x8021a0,(%esp)
  ...
  800f96:	e8 11 00 00 00       	call   800fac <vcprintf>
	cprintf("\n");
  800f9b:	c7 04 24 94 21 80 00 	movl   $0x802194,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801000:	e8 f7 f0 ff ff       	call   8000fc <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  801054:	e8 a3 f0 ff ff       	call   8000fc <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801150:	0f be 80 c3 21 80 00 	movsbl 0x8021c3(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801306:	c7 44 24 08 d4 21 80 	movl   $0x8021d4,0x8(%esp)
  80130d:	00 
  ...
  80132c:	c7 44 24 08 dd 21 80 	movl   $0x8021dd,0x8(%esp)
  801333:	00 
  ...
  80136a:	be e0 21 80 00       	mov    $0x8021e0,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801669:	0f be 80 c3 21 80 00 	movsbl 0x8021c3(%eax),%eax
  ...
  801715:	c7 44 24 0c fc 22 80 	movl   $0x8022fc,0xc(%esp)
  80171c:	00 
  80171d:	c7 44 24 08 dd 21 80 	movl   $0x8021dd,0x8(%esp)
  801724:	00 
  ...
  80174b:	c7 44 24 0c 34 23 80 	movl   $0x802334,0xc(%esp)
  801752:	00 
  801753:	c7 44 24 08 dd 21 80 	movl   $0x8021dd,0x8(%esp)
  80175a:	00 
  ...
  8017e8:	0f be 80 c3 21 80 00 	movsbl 0x8021c3(%eax),%eax
  ...
  80182a:	0f be 80 c3 21 80 00 	movsbl 0x8021c3(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801da3:	e8 ec e4 ff ff       	call   800294 <sys_ipc_try_send>
  ...
  801dc0:	e8 cf e4 ff ff       	call   800294 <sys_ipc_try_send>
           if(ret == 0)
  ...
  801de5:	e8 6a f1 ff ff       	call   800f54 <_panic>
           sys_yield();
  801dea:	e8 71 e7 ff ff       	call   800560 <sys_yield>
        }
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801e15:	e8 0f e4 ff ff       	call   800229 <sys_ipc_recv>
  801e1a:	eb 08                	jmp    801e24 <ipc_recv+0x2b>
        else
           ret = sys_ipc_recv(pg);
  801e1c:	89 04 24             	mov    %eax,(%esp)
  801e1f:	e8 05 e4 ff ff       	call   800229 <sys_ipc_recv>
        if(ret == 0){
