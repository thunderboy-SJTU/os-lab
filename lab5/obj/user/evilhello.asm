...
libmain(int argc, char **argv)
{
  ...
  800062:	e8 7f 05 00 00       	call   8005e6 <sys_getenvid>
...
exit(void)
{
  ...
  8000a7:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000aa:	e8 cc 0a 00 00       	call   800b7b <close_all>
	sys_env_destroy(0);
  8000af:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000b6:	e8 6b 05 00 00       	call   800626 <sys_env_destroy>
}
  8000bb:	c9                   	leave  
  8000bc:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  80014c:	b8 10 00 00 00       	mov    $0x10,%eax
  800151:	8b 7d 14             	mov    0x14(%ebp),%edi
  800154:	8b 5d 10             	mov    0x10(%ebp),%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001b8:	7e 28                	jle    8001e2 <sys_env_set_prior+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001ba:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001be:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  8001c5:	00 
  8001c6:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  8001cd:	00 
  8001ce:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8001d5:	00 
  8001d6:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  8001dd:	e8 82 0d 00 00       	call   800f64 <_panic>
}
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  8001e2:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001fe:	b8 11 00 00 00       	mov    $0x11,%eax
  800203:	8b 55 08             	mov    0x8(%ebp),%edx
  800206:	89 cb                	mov    %ecx,%ebx
  800208:	89 cf                	mov    %ecx,%edi
  80020a:	51                   	push   %ecx
  80020b:	52                   	push   %edx
  80020c:	53                   	push   %ebx
  80020d:	54                   	push   %esp
...
sys_ipc_recv(void *dstva)
{
  ...
  800230:	83 ec 28             	sub    $0x28,%esp
  800233:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800236:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800239:	b9 00 00 00 00       	mov    $0x0,%ecx
  80023e:	b8 0e 00 00 00       	mov    $0xe,%eax
  800243:	8b 55 08             	mov    0x8(%ebp),%edx
  800246:	89 cb                	mov    %ecx,%ebx
  800248:	89 cf                	mov    %ecx,%edi
  80024a:	51                   	push   %ecx
  80024b:	52                   	push   %edx
  80024c:	53                   	push   %ebx
  80024d:	54                   	push   %esp
  ...
  800264:	7e 28                	jle    80028e <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800266:	89 44 24 10          	mov    %eax,0x10(%esp)
  80026a:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  800271:	00 
  800272:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800279:	00 
  80027a:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800281:	00 
  800282:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  800289:	e8 d6 0c 00 00       	call   800f64 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8002a5:	b8 0d 00 00 00       	mov    $0xd,%eax
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8002ce:	8b 1c 24             	mov    (%esp),%ebx
  8002d1:	8b 7c 24 04          	mov    0x4(%esp),%edi
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002df:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8002e2:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002fe:	54                   	push   %esp
  8002ff:	5d                   	pop    %ebp
  800300:	8d 35 08 03 80 00    	lea    0x800308,%esi
  800306:	0f 34                	sysenter 
  800308:	5f                   	pop    %edi
  800309:	5e                   	pop    %esi
  80030a:	5d                   	pop    %ebp
  80030b:	5c                   	pop    %esp
  ...
  800311:	7e 28                	jle    80033b <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800313:	89 44 24 10          	mov    %eax,0x10(%esp)
  800317:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  80031e:	00 
  80031f:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800326:	00 
  800327:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80032e:	00 
  80032f:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  800336:	e8 29 0c 00 00       	call   800f64 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80033b:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80034b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80034e:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80037d:	7e 28                	jle    8003a7 <sys_env_set_trapframe+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80037f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800383:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80038a:	00 
  80038b:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800392:	00 
  800393:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80039a:	00 
  80039b:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  8003a2:	e8 bd 0b 00 00       	call   800f64 <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8003a7:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8003aa:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8003ad:	89 ec                	mov    %ebp,%esp
  8003af:	5d                   	pop    %ebp
  8003b0:	c3                   	ret    

008003b1 <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8003b7:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8003c2:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8003e9:	7e 28                	jle    800413 <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003eb:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003ef:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8003f6:	00 
  8003f7:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  8003fe:	00 
  8003ff:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800406:	00 
  800407:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  80040e:	e8 51 0b 00 00       	call   800f64 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800413:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800416:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800419:	89 ec                	mov    %ebp,%esp
  80041b:	5d                   	pop    %ebp
  80041c:	c3                   	ret    

0080041d <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800420:	83 ec 28             	sub    $0x28,%esp
  800423:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800426:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80042e:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  800442:	54                   	push   %esp
  800443:	5d                   	pop    %ebp
  800444:	8d 35 4c 04 80 00    	lea    0x80044c,%esi
  80044a:	0f 34                	sysenter 
  80044c:	5f                   	pop    %edi
  80044d:	5e                   	pop    %esi
  80044e:	5d                   	pop    %ebp
  80044f:	5c                   	pop    %esp
  ...
  800455:	7e 28                	jle    80047f <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800457:	89 44 24 10          	mov    %eax,0x10(%esp)
  80045b:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  800462:	00 
  800463:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  80046a:	00 
  80046b:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800472:	00 
  800473:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  80047a:	e8 e5 0a 00 00       	call   800f64 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80047f:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800482:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800485:	89 ec                	mov    %ebp,%esp
  800487:	5d                   	pop    %ebp
  800488:	c3                   	ret    

00800489 <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80048c:	83 ec 28             	sub    $0x28,%esp
  80048f:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800492:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800495:	8b 7d 18             	mov    0x18(%ebp),%edi
  800498:	0b 7d 14             	or     0x14(%ebp),%edi
  80049b:	b8 06 00 00 00       	mov    $0x6,%eax
  8004a0:	8b 5d 10             	mov    0x10(%ebp),%ebx
  8004a3:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  8004b0:	54                   	push   %esp
  8004b1:	5d                   	pop    %ebp
  8004b2:	8d 35 ba 04 80 00    	lea    0x8004ba,%esi
  8004b8:	0f 34                	sysenter 
  8004ba:	5f                   	pop    %edi
  8004bb:	5e                   	pop    %esi
  8004bc:	5d                   	pop    %ebp
  8004bd:	5c                   	pop    %esp
  ...
  8004c3:	7e 28                	jle    8004ed <sys_page_map+0x64>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004c5:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004c9:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  8004d0:	00 
  8004d1:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  8004d8:	00 
  8004d9:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8004e0:	00 
  8004e1:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  8004e8:	e8 77 0a 00 00       	call   800f64 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8004fa:	83 ec 28             	sub    $0x28,%esp
  8004fd:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800500:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800508:	b8 05 00 00 00       	mov    $0x5,%eax
  ...
  80051d:	54                   	push   %esp
  80051e:	5d                   	pop    %ebp
  80051f:	8d 35 27 05 80 00    	lea    0x800527,%esi
  800525:	0f 34                	sysenter 
  800527:	5f                   	pop    %edi
  800528:	5e                   	pop    %esi
  800529:	5d                   	pop    %ebp
  80052a:	5c                   	pop    %esp
  ...
  800530:	7e 28                	jle    80055a <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  800532:	89 44 24 10          	mov    %eax,0x10(%esp)
  800536:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  80053d:	00 
  80053e:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800545:	00 
  800546:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80054d:	00 
  80054e:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  800555:	e8 0a 0a 00 00       	call   800f64 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80055a:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80055d:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800560:	89 ec                	mov    %ebp,%esp
  800562:	5d                   	pop    %ebp
  800563:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800576:	b8 0c 00 00 00       	mov    $0xc,%eax
  80057b:	89 d1                	mov    %edx,%ecx
  ...
  800588:	54                   	push   %esp
  800589:	5d                   	pop    %ebp
  80058a:	8d 35 92 05 80 00    	lea    0x800592,%esi
  800590:	0f 34                	sysenter 
  800592:	5f                   	pop    %edi
  800593:	5e                   	pop    %esi
  800594:	5d                   	pop    %ebp
  800595:	5c                   	pop    %esp
...
sys_yield(void)
{
  ...
  800599:	8b 1c 24             	mov    (%esp),%ebx
  80059c:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8005a0:	89 ec                	mov    %ebp,%esp
  8005a2:	5d                   	pop    %ebp
  8005a3:	c3                   	ret    

008005a4 <sys_map_kernel_page>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8005b6:	b8 04 00 00 00       	mov    $0x4,%eax
  ...
  8005ca:	54                   	push   %esp
  8005cb:	5d                   	pop    %ebp
  8005cc:	8d 35 d4 05 80 00    	lea    0x8005d4,%esi
  8005d2:	0f 34                	sysenter 
  8005d4:	5f                   	pop    %edi
  8005d5:	5e                   	pop    %esi
  8005d6:	5d                   	pop    %ebp
  8005d7:	5c                   	pop    %esp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  8005db:	8b 1c 24             	mov    (%esp),%ebx
  8005de:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8005e2:	89 ec                	mov    %ebp,%esp
  8005e4:	5d                   	pop    %ebp
  8005e5:	c3                   	ret    

008005e6 <sys_getenvid>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8005f8:	b8 02 00 00 00       	mov    $0x2,%eax
  ...
  80060a:	54                   	push   %esp
  80060b:	5d                   	pop    %ebp
  80060c:	8d 35 14 06 80 00    	lea    0x800614,%esi
  800612:	0f 34                	sysenter 
  800614:	5f                   	pop    %edi
  800615:	5e                   	pop    %esi
  800616:	5d                   	pop    %ebp
  800617:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  80061b:	8b 1c 24             	mov    (%esp),%ebx
  80061e:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800622:	89 ec                	mov    %ebp,%esp
  800624:	5d                   	pop    %ebp
  800625:	c3                   	ret    

00800626 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  800629:	83 ec 28             	sub    $0x28,%esp
  80062c:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80062f:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800637:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  80065d:	7e 28                	jle    800687 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  80065f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800663:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80066a:	00 
  80066b:	c7 44 24 08 0a 21 80 	movl   $0x80210a,0x8(%esp)
  800672:	00 
  800673:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80067a:	00 
  80067b:	c7 04 24 27 21 80 00 	movl   $0x802127,(%esp)
  800682:	e8 dd 08 00 00       	call   800f64 <_panic>
...
{
	&devfile,
  8007bf:	b8 04 30 80 00       	mov    $0x803004,%eax
{
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  8007c9:	be b4 21 80 00       	mov    $0x8021b4,%esi
		if (devtab[i]->dev_id == dev_id) {
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8007fc:	c7 04 24 38 21 80 00 	movl   $0x802138,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008e1:	c7 04 24 58 21 80 00 	movl   $0x802158,(%esp)
  ...
  800941:	e8 6b fe ff ff       	call   8007b1 <dev_lookup>
{
  ...
  800963:	c7 04 24 79 21 80 00 	movl   $0x802179,(%esp)
  ...
  8009ca:	e8 e2 fd ff ff       	call   8007b1 <dev_lookup>
{
  ...
  8009f1:	c7 04 24 96 21 80 00 	movl   $0x802196,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800af0:	e8 28 f9 ff ff       	call   80041d <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800c3e:	e8 46 f8 ff ff       	call   800489 <sys_page_map>
  ...
  800c79:	e8 0b f8 ff ff       	call   800489 <sys_page_map>
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800f6f:	8b 1d 00 30 80 00    	mov    0x803000,%ebx
  800f75:	e8 6c f6 ff ff       	call   8005e6 <sys_getenvid>
  ...
  800f90:	c7 04 24 bc 21 80 00 	movl   $0x8021bc,(%esp)
  ...
  800fa6:	e8 11 00 00 00       	call   800fbc <vcprintf>
	cprintf("\n");
  800fab:	c7 04 24 b0 21 80 00 	movl   $0x8021b0,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801010:	e8 eb f0 ff ff       	call   800100 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  801064:	e8 97 f0 ff ff       	call   800100 <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801160:	0f be 80 df 21 80 00 	movsbl 0x8021df(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801316:	c7 44 24 08 f0 21 80 	movl   $0x8021f0,0x8(%esp)
  80131d:	00 
  ...
  80133c:	c7 44 24 08 f9 21 80 	movl   $0x8021f9,0x8(%esp)
  801343:	00 
  ...
  80137a:	be fc 21 80 00       	mov    $0x8021fc,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801679:	0f be 80 df 21 80 00 	movsbl 0x8021df(%eax),%eax
  ...
  801725:	c7 44 24 0c 18 23 80 	movl   $0x802318,0xc(%esp)
  80172c:	00 
  80172d:	c7 44 24 08 f9 21 80 	movl   $0x8021f9,0x8(%esp)
  801734:	00 
  ...
  80175b:	c7 44 24 0c 50 23 80 	movl   $0x802350,0xc(%esp)
  801762:	00 
  801763:	c7 44 24 08 f9 21 80 	movl   $0x8021f9,0x8(%esp)
  80176a:	00 
  ...
  8017f8:	0f be 80 df 21 80 00 	movsbl 0x8021df(%eax),%eax
  ...
  80183a:	0f be 80 df 21 80 00 	movsbl 0x8021df(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801db3:	e8 e0 e4 ff ff       	call   800298 <sys_ipc_try_send>
  ...
  801dd0:	e8 c3 e4 ff ff       	call   800298 <sys_ipc_try_send>
           if(ret == 0)
  ...
  801df5:	e8 6a f1 ff ff       	call   800f64 <_panic>
           sys_yield();
  801dfa:	e8 65 e7 ff ff       	call   800564 <sys_yield>
        }
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801e25:	e8 03 e4 ff ff       	call   80022d <sys_ipc_recv>
  801e2a:	eb 08                	jmp    801e34 <ipc_recv+0x2b>
        else
           ret = sys_ipc_recv(pg);
  801e2c:	89 04 24             	mov    %eax,(%esp)
  801e2f:	e8 f9 e3 ff ff       	call   80022d <sys_ipc_recv>
        if(ret == 0){
