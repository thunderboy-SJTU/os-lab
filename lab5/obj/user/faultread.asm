	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800270:	0f be 80 28 21 80 00 	movsbl 0x802128(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80035a:	ff 24 95 00 23 80 00 	jmp    *0x802300(,%edx,4)
  ...
  80044c:	c7 44 24 08 42 21 80 	movl   $0x802142,0x8(%esp)
  800453:	00 
  ...
  80048a:	be 45 21 80 00       	mov    $0x802145,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800789:	0f be 80 28 21 80 00 	movsbl 0x802128(%eax),%eax
  ...
  800835:	c7 44 24 0c 60 22 80 	movl   $0x802260,0xc(%esp)
  80083c:	00 
  80083d:	c7 44 24 08 42 21 80 	movl   $0x802142,0x8(%esp)
  800844:	00 
  ...
  80086b:	c7 44 24 0c 98 22 80 	movl   $0x802298,0xc(%esp)
  800872:	00 
  800873:	c7 44 24 08 42 21 80 	movl   $0x802142,0x8(%esp)
  80087a:	00 
  ...
  800908:	0f be 80 28 21 80 00 	movsbl 0x802128(%eax),%eax
  ...
  80094a:	0f be 80 28 21 80 00 	movsbl 0x802128(%eax),%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f51:	00 
  800f52:	c7 44 24 08 a0 24 80 	movl   $0x8024a0,0x8(%esp)
  800f59:	00 
  800f5a:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800f61:	00 
  800f62:	c7 04 24 bd 24 80 00 	movl   $0x8024bd,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ffd:	00 
  800ffe:	c7 44 24 08 a0 24 80 	movl   $0x8024a0,0x8(%esp)
  801005:	00 
  801006:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80100d:	00 
  80100e:	c7 04 24 bd 24 80 00 	movl   $0x8024bd,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8010aa:	00 
  8010ab:	c7 44 24 08 a0 24 80 	movl   $0x8024a0,0x8(%esp)
  8010b2:	00 
  8010b3:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8010ba:	00 
  8010bb:	c7 04 24 bd 24 80 00 	movl   $0x8024bd,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801116:	00 
  801117:	c7 44 24 08 a0 24 80 	movl   $0x8024a0,0x8(%esp)
  80111e:	00 
  80111f:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801126:	00 
  801127:	c7 04 24 bd 24 80 00 	movl   $0x8024bd,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801182:	00 
  801183:	c7 44 24 08 a0 24 80 	movl   $0x8024a0,0x8(%esp)
  80118a:	00 
  80118b:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801192:	00 
  801193:	c7 04 24 bd 24 80 00 	movl   $0x8024bd,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8011ee:	00 
  8011ef:	c7 44 24 08 a0 24 80 	movl   $0x8024a0,0x8(%esp)
  8011f6:	00 
  8011f7:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8011fe:	00 
  8011ff:	c7 04 24 bd 24 80 00 	movl   $0x8024bd,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80125c:	00 
  80125d:	c7 44 24 08 a0 24 80 	movl   $0x8024a0,0x8(%esp)
  801264:	00 
  801265:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80126c:	00 
  80126d:	c7 04 24 bd 24 80 00 	movl   $0x8024bd,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8012c9:	00 
  8012ca:	c7 44 24 08 a0 24 80 	movl   $0x8024a0,0x8(%esp)
  8012d1:	00 
  8012d2:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8012d9:	00 
  8012da:	c7 04 24 bd 24 80 00 	movl   $0x8024bd,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8013f6:	00 
  8013f7:	c7 44 24 08 a0 24 80 	movl   $0x8024a0,0x8(%esp)
  8013fe:	00 
  8013ff:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801406:	00 
  801407:	c7 04 24 bd 24 80 00 	movl   $0x8024bd,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  801549:	be 48 25 80 00       	mov    $0x802548,%esi
		if (devtab[i]->dev_id == dev_id) {
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80157c:	c7 04 24 cc 24 80 00 	movl   $0x8024cc,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801661:	c7 04 24 ec 24 80 00 	movl   $0x8024ec,(%esp)
  ...
  8016c1:	e8 6b fe ff ff       	call   801531 <dev_lookup>
{
  ...
  8016e3:	c7 04 24 0d 25 80 00 	movl   $0x80250d,(%esp)
  ...
  80174a:	e8 e2 fd ff ff       	call   801531 <dev_lookup>
{
  ...
  801771:	c7 04 24 2a 25 80 00 	movl   $0x80252a,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  801d10:	c7 04 24 50 25 80 00 	movl   $0x802550,(%esp)
  ...
  801d26:	e8 99 e3 ff ff       	call   8000c4 <vcprintf>
	cprintf("\n");
  801d2b:	c7 04 24 1c 21 80 00 	movl   $0x80211c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801dde:	c7 44 24 08 74 25 80 	movl   $0x802574,0x8(%esp)
  801de5:	00 
  801de6:	c7 44 24 04 46 00 00 	movl   $0x46,0x4(%esp)
  801ded:	00 
  801dee:	c7 04 24 83 25 80 00 	movl   $0x802583,(%esp)
