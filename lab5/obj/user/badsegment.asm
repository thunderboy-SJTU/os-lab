...
libmain(int argc, char **argv)
{
  ...
  800052:	e8 7f 05 00 00       	call   8005d6 <sys_getenvid>
...
exit(void)
{
  ...
  800097:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009a:	e8 cc 0a 00 00       	call   800b6b <close_all>
	sys_env_destroy(0);
  80009f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a6:	e8 6b 05 00 00       	call   800616 <sys_env_destroy>
}
  8000ab:	c9                   	leave  
  8000ac:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  80013c:	b8 10 00 00 00       	mov    $0x10,%eax
  800141:	8b 7d 14             	mov    0x14(%ebp),%edi
  800144:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800147:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800181:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  8001a8:	7e 28                	jle    8001d2 <sys_env_set_prior+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001aa:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001ae:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  8001b5:	00 
  8001b6:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  8001bd:	00 
  8001be:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8001c5:	00 
  8001c6:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  8001cd:	e8 82 0d 00 00       	call   800f54 <_panic>
}
...
sys_env_set_prior(envid_t envid, uint32_t prior){
  ...
  8001d2:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001ee:	b8 11 00 00 00       	mov    $0x11,%eax
  8001f3:	8b 55 08             	mov    0x8(%ebp),%edx
  8001f6:	89 cb                	mov    %ecx,%ebx
  8001f8:	89 cf                	mov    %ecx,%edi
  8001fa:	51                   	push   %ecx
  8001fb:	52                   	push   %edx
  8001fc:	53                   	push   %ebx
  8001fd:	54                   	push   %esp
  ...
  800201:	54                   	push   %esp
  800202:	5d                   	pop    %ebp
  800203:	8d 35 0b 02 80 00    	lea    0x80020b,%esi
  800209:	0f 34                	sysenter 
  80020b:	5f                   	pop    %edi
  80020c:	5e                   	pop    %esi
  80020d:	5d                   	pop    %ebp
  80020e:	5c                   	pop    %esp
...
sys_ipc_recv(void *dstva)
{
  ...
  800223:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800226:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80022e:	b8 0e 00 00 00       	mov    $0xe,%eax
  800233:	8b 55 08             	mov    0x8(%ebp),%edx
  800236:	89 cb                	mov    %ecx,%ebx
  800238:	89 cf                	mov    %ecx,%edi
  80023a:	51                   	push   %ecx
  80023b:	52                   	push   %edx
  80023c:	53                   	push   %ebx
  80023d:	54                   	push   %esp
  ...
  800254:	7e 28                	jle    80027e <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800256:	89 44 24 10          	mov    %eax,0x10(%esp)
  80025a:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  800261:	00 
  800262:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  800269:	00 
  80026a:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800271:	00 
  800272:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  800279:	e8 d6 0c 00 00       	call   800f54 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800295:	b8 0d 00 00 00       	mov    $0xd,%eax
  80029a:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002cf:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8002d2:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002ee:	54                   	push   %esp
  8002ef:	5d                   	pop    %ebp
  8002f0:	8d 35 f8 02 80 00    	lea    0x8002f8,%esi
  8002f6:	0f 34                	sysenter 
  8002f8:	5f                   	pop    %edi
  8002f9:	5e                   	pop    %esi
  8002fa:	5d                   	pop    %ebp
  8002fb:	5c                   	pop    %esp
  ...
  800301:	7e 28                	jle    80032b <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800303:	89 44 24 10          	mov    %eax,0x10(%esp)
  800307:	c7 44 24 0c 0b 00 00 	movl   $0xb,0xc(%esp)
  80030e:	00 
  80030f:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  800316:	00 
  800317:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80031e:	00 
  80031f:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  800326:	e8 29 0c 00 00       	call   800f54 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80032b:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80032e:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800331:	89 ec                	mov    %ebp,%esp
  800333:	5d                   	pop    %ebp
  800334:	c3                   	ret    

00800335 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80033b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  80033e:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80036d:	7e 28                	jle    800397 <sys_env_set_trapframe+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80036f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800373:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80037a:	00 
  80037b:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  800382:	00 
  800383:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80038a:	00 
  80038b:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  800392:	e8 bd 0b 00 00       	call   800f54 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8003a7:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8003ad:	bb 00 00 00 00       	mov    $0x0,%ebx
  8003b2:	b8 09 00 00 00       	mov    $0x9,%eax
  8003b7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  8003ba:	8b 55 08             	mov    0x8(%ebp),%edx
  8003bd:	89 df                	mov    %ebx,%edi
  8003bf:	51                   	push   %ecx
  8003c0:	52                   	push   %edx
  8003c1:	53                   	push   %ebx
  8003c2:	54                   	push   %esp
  ...
  8003d9:	7e 28                	jle    800403 <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003db:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003df:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8003e6:	00 
  8003e7:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  8003ee:	00 
  8003ef:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8003f6:	00 
  8003f7:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  8003fe:	e8 51 0b 00 00       	call   800f54 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800410:	83 ec 28             	sub    $0x28,%esp
  800413:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800416:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800423:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  800445:	7e 28                	jle    80046f <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800447:	89 44 24 10          	mov    %eax,0x10(%esp)
  80044b:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  800452:	00 
  800453:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  80045a:	00 
  80045b:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  800462:	00 
  800463:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  80046a:	e8 e5 0a 00 00       	call   800f54 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80046f:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80047f:	89 5d f8             	mov    %ebx,-0x8(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  800485:	8b 7d 18             	mov    0x18(%ebp),%edi
  800488:	0b 7d 14             	or     0x14(%ebp),%edi
  80048b:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  8004a0:	54                   	push   %esp
  8004a1:	5d                   	pop    %ebp
  8004a2:	8d 35 aa 04 80 00    	lea    0x8004aa,%esi
  8004a8:	0f 34                	sysenter 
  8004aa:	5f                   	pop    %edi
  8004ab:	5e                   	pop    %esi
  8004ac:	5d                   	pop    %ebp
  8004ad:	5c                   	pop    %esp
  ...
  8004b3:	7e 28                	jle    8004dd <sys_page_map+0x64>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004b5:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004b9:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  8004c0:	00 
  8004c1:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  8004c8:	00 
  8004c9:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8004d0:	00 
  8004d1:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  8004d8:	e8 77 0a 00 00       	call   800f54 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8004dd:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8004e0:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004e3:	89 ec                	mov    %ebp,%esp
  8004e5:	5d                   	pop    %ebp
  8004e6:	c3                   	ret    

008004e7 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8004ed:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8004f0:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8004f3:	bf 00 00 00 00       	mov    $0x0,%edi
  8004f8:	b8 05 00 00 00       	mov    $0x5,%eax
  8004fd:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800500:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ...
  80050d:	54                   	push   %esp
  80050e:	5d                   	pop    %ebp
  80050f:	8d 35 17 05 80 00    	lea    0x800517,%esi
  800515:	0f 34                	sysenter 
  800517:	5f                   	pop    %edi
  800518:	5e                   	pop    %esi
  800519:	5d                   	pop    %ebp
  80051a:	5c                   	pop    %esp
  ...
  800520:	7e 28                	jle    80054a <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  800522:	89 44 24 10          	mov    %eax,0x10(%esp)
  800526:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  80052d:	00 
  80052e:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  800535:	00 
  800536:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80053d:	00 
  80053e:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  800545:	e8 0a 0a 00 00       	call   800f54 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80054a:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80054d:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800550:	89 ec                	mov    %ebp,%esp
  800552:	5d                   	pop    %ebp
  800553:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800566:	b8 0c 00 00 00       	mov    $0xc,%eax
  ...
  800578:	54                   	push   %esp
  800579:	5d                   	pop    %ebp
  80057a:	8d 35 82 05 80 00    	lea    0x800582,%esi
  800580:	0f 34                	sysenter 
  800582:	5f                   	pop    %edi
  800583:	5e                   	pop    %esi
  800584:	5d                   	pop    %ebp
  800585:	5c                   	pop    %esp
...
sys_yield(void)
{
  ...
  800589:	8b 1c 24             	mov    (%esp),%ebx
  80058c:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800590:	89 ec                	mov    %ebp,%esp
  800592:	5d                   	pop    %ebp
  800593:	c3                   	ret    

00800594 <sys_map_kernel_page>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8005a6:	b8 04 00 00 00       	mov    $0x4,%eax
  ...
  8005ba:	54                   	push   %esp
  8005bb:	5d                   	pop    %ebp
  8005bc:	8d 35 c4 05 80 00    	lea    0x8005c4,%esi
  8005c2:	0f 34                	sysenter 
  8005c4:	5f                   	pop    %edi
  8005c5:	5e                   	pop    %esi
  8005c6:	5d                   	pop    %ebp
  8005c7:	5c                   	pop    %esp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  8005cb:	8b 1c 24             	mov    (%esp),%ebx
  8005ce:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8005d2:	89 ec                	mov    %ebp,%esp
  8005d4:	5d                   	pop    %ebp
  8005d5:	c3                   	ret    

008005d6 <sys_getenvid>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8005fa:	54                   	push   %esp
  8005fb:	5d                   	pop    %ebp
  8005fc:	8d 35 04 06 80 00    	lea    0x800604,%esi
  800602:	0f 34                	sysenter 
  800604:	5f                   	pop    %edi
  800605:	5e                   	pop    %esi
  800606:	5d                   	pop    %ebp
  800607:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  80060b:	8b 1c 24             	mov    (%esp),%ebx
  80060e:	8b 7c 24 04          	mov    0x4(%esp),%edi
  800612:	89 ec                	mov    %ebp,%esp
  800614:	5d                   	pop    %ebp
  800615:	c3                   	ret    

00800616 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800627:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  80063a:	54                   	push   %esp
  80063b:	5d                   	pop    %ebp
  80063c:	8d 35 44 06 80 00    	lea    0x800644,%esi
  800642:	0f 34                	sysenter 
  800644:	5f                   	pop    %edi
  800645:	5e                   	pop    %esi
  800646:	5d                   	pop    %ebp
  800647:	5c                   	pop    %esp
  ...
  80064d:	7e 28                	jle    800677 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  80064f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800653:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80065a:	00 
  80065b:	c7 44 24 08 ea 20 80 	movl   $0x8020ea,0x8(%esp)
  800662:	00 
  800663:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80066a:	00 
  80066b:	c7 04 24 07 21 80 00 	movl   $0x802107,(%esp)
  800672:	e8 dd 08 00 00       	call   800f54 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  80067a:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800ae0:	e8 28 f9 ff ff       	call   80040d <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800c2e:	e8 46 f8 ff ff       	call   800479 <sys_page_map>
  ...
  800c69:	e8 0b f8 ff ff       	call   800479 <sys_page_map>
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800f65:	e8 6c f6 ff ff       	call   8005d6 <sys_getenvid>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801000:	e8 eb f0 ff ff       	call   8000f0 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  801054:	e8 97 f0 ff ff       	call   8000f0 <sys_cputs>
		b->idx = 0;
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801da3:	e8 e0 e4 ff ff       	call   800288 <sys_ipc_try_send>
  ...
  801dc0:	e8 c3 e4 ff ff       	call   800288 <sys_ipc_try_send>
           if(ret == 0)
  ...
  801de5:	e8 6a f1 ff ff       	call   800f54 <_panic>
           sys_yield();
  801dea:	e8 65 e7 ff ff       	call   800554 <sys_yield>
        }
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801e15:	e8 03 e4 ff ff       	call   80021d <sys_ipc_recv>
  801e1a:	eb 08                	jmp    801e24 <ipc_recv+0x2b>
        else
           ret = sys_ipc_recv(pg);
  801e1c:	89 04 24             	mov    %eax,(%esp)
  801e1f:	e8 f9 e3 ff ff       	call   80021d <sys_ipc_recv>
        if(ret == 0){
