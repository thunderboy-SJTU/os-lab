...
umain(int argc, char **argv)
{
  ...
  800070:	c7 04 24 20 22 80 00 	movl   $0x802220,(%esp)
  ...
  8000a3:	c7 04 24 80 22 80 00 	movl   $0x802280,(%esp)
  8000aa:	e8 a2 01 00 00       	call   800251 <cprintf>
  8000af:	eb 0c                	jmp    8000bd <umain+0x5c>
			x, want);
	else
		cprintf("init: data seems okay\n");
  8000b1:	c7 04 24 2f 22 80 00 	movl   $0x80222f,(%esp)
  ...
  8000d9:	c7 04 24 bc 22 80 00 	movl   $0x8022bc,(%esp)
  8000e0:	e8 6c 01 00 00       	call   800251 <cprintf>
  8000e5:	eb 0c                	jmp    8000f3 <umain+0x92>
	else
		cprintf("init: bss seems okay\n");
  8000e7:	c7 04 24 46 22 80 00 	movl   $0x802246,(%esp)
  8000ee:	e8 5e 01 00 00       	call   800251 <cprintf>

	// output in one syscall per line to avoid output interleaving 
	strcat(args, "init: args:");
  8000f3:	c7 44 24 04 5c 22 80 	movl   $0x80225c,0x4(%esp)
  8000fa:	00 
  ...
  80011a:	c7 44 24 04 68 22 80 	movl   $0x802268,0x4(%esp)
  800121:	00 
  ...
  800134:	e8 61 0a 00 00       	call   800b9a <strcat>
		strcat(args, "'");
  800139:	c7 44 24 04 69 22 80 	movl   $0x802269,0x4(%esp)
  800140:	00 
  ...
  80015b:	c7 04 24 6b 22 80 00 	movl   $0x80226b,(%esp)
  800162:	e8 ea 00 00 00       	call   800251 <cprintf>

	cprintf("init: exiting\n");
  800167:	c7 04 24 6f 22 80 00 	movl   $0x80226f,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  800192:	e8 fb 12 00 00       	call   801492 <sys_getenvid>
...
exit(void)
{
  ...
  8001d7:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8001da:	e8 3c 18 00 00       	call   801a1b <close_all>
	sys_env_destroy(0);
  8001df:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8001e6:	e8 e7 12 00 00       	call   8014d2 <sys_env_destroy>
}
  8001eb:	c9                   	leave  
  8001ec:	c3                   	ret    
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80031f:	e8 7c 1c 00 00       	call   801fa0 <__udivdi3>
  ...
  800387:	e8 44 1d 00 00       	call   8020d0 <__umoddi3>
  80038c:	89 74 24 04          	mov    %esi,0x4(%esp)
  800390:	0f be 80 f5 22 80 00 	movsbl 0x8022f5(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80047a:	ff 24 95 e0 24 80 00 	jmp    *0x8024e0(,%edx,4)
  ...
  80056c:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  800573:	00 
  ...
  8005aa:	be 12 23 80 00       	mov    $0x802312,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800854:	e8 47 17 00 00       	call   801fa0 <__udivdi3>
  ...
  8008a0:	e8 2b 18 00 00       	call   8020d0 <__umoddi3>
  8008a5:	89 74 24 04          	mov    %esi,0x4(%esp)
  8008a9:	0f be 80 f5 22 80 00 	movsbl 0x8022f5(%eax),%eax
  ...
  800955:	c7 44 24 0c 2c 24 80 	movl   $0x80242c,0xc(%esp)
  80095c:	00 
  80095d:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  800964:	00 
  ...
  80098b:	c7 44 24 0c 64 24 80 	movl   $0x802464,0xc(%esp)
  800992:	00 
  800993:	c7 44 24 08 0f 23 80 	movl   $0x80230f,0x8(%esp)
  80099a:	00 
  ...
  800a1f:	e8 ac 16 00 00       	call   8020d0 <__umoddi3>
  800a24:	89 74 24 04          	mov    %esi,0x4(%esp)
  800a28:	0f be 80 f5 22 80 00 	movsbl 0x8022f5(%eax),%eax
  ...
  800a61:	e8 6a 16 00 00       	call   8020d0 <__umoddi3>
  800a66:	89 74 24 04          	mov    %esi,0x4(%esp)
  800a6a:	0f be 80 f5 22 80 00 	movsbl 0x8022f5(%eax),%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801071:	00 
  801072:	c7 44 24 08 80 26 80 	movl   $0x802680,0x8(%esp)
  801079:	00 
  80107a:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801081:	00 
  801082:	c7 04 24 9d 26 80 00 	movl   $0x80269d,(%esp)
  801089:	e8 76 0d 00 00       	call   801e04 <_panic>
}
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80111d:	00 
  80111e:	c7 44 24 08 80 26 80 	movl   $0x802680,0x8(%esp)
  801125:	00 
  801126:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80112d:	00 
  80112e:	c7 04 24 9d 26 80 00 	movl   $0x80269d,(%esp)
  801135:	e8 ca 0c 00 00       	call   801e04 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8011ca:	00 
  8011cb:	c7 44 24 08 80 26 80 	movl   $0x802680,0x8(%esp)
  8011d2:	00 
  8011d3:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8011da:	00 
  8011db:	c7 04 24 9d 26 80 00 	movl   $0x80269d,(%esp)
  8011e2:	e8 1d 0c 00 00       	call   801e04 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801236:	00 
  801237:	c7 44 24 08 80 26 80 	movl   $0x802680,0x8(%esp)
  80123e:	00 
  80123f:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801246:	00 
  801247:	c7 04 24 9d 26 80 00 	movl   $0x80269d,(%esp)
  80124e:	e8 b1 0b 00 00       	call   801e04 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8012a2:	00 
  8012a3:	c7 44 24 08 80 26 80 	movl   $0x802680,0x8(%esp)
  8012aa:	00 
  8012ab:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8012b2:	00 
  8012b3:	c7 04 24 9d 26 80 00 	movl   $0x80269d,(%esp)
  8012ba:	e8 45 0b 00 00       	call   801e04 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80130e:	00 
  80130f:	c7 44 24 08 80 26 80 	movl   $0x802680,0x8(%esp)
  801316:	00 
  801317:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80131e:	00 
  80131f:	c7 04 24 9d 26 80 00 	movl   $0x80269d,(%esp)
  801326:	e8 d9 0a 00 00       	call   801e04 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80137c:	00 
  80137d:	c7 44 24 08 80 26 80 	movl   $0x802680,0x8(%esp)
  801384:	00 
  801385:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  80138c:	00 
  80138d:	c7 04 24 9d 26 80 00 	movl   $0x80269d,(%esp)
  801394:	e8 6b 0a 00 00       	call   801e04 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8013e9:	00 
  8013ea:	c7 44 24 08 80 26 80 	movl   $0x802680,0x8(%esp)
  8013f1:	00 
  8013f2:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  8013f9:	00 
  8013fa:	c7 04 24 9d 26 80 00 	movl   $0x80269d,(%esp)
  801401:	e8 fe 09 00 00       	call   801e04 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801516:	00 
  801517:	c7 44 24 08 80 26 80 	movl   $0x802680,0x8(%esp)
  80151e:	00 
  80151f:	c7 44 24 04 28 00 00 	movl   $0x28,0x4(%esp)
  801526:	00 
  801527:	c7 04 24 9d 26 80 00 	movl   $0x80269d,(%esp)
  80152e:	e8 d1 08 00 00       	call   801e04 <_panic>
...
{
	&devfile,
  80165f:	b8 74 47 80 00       	mov    $0x804774,%eax
{
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  801669:	be 28 27 80 00       	mov    $0x802728,%esi
		if (devtab[i]->dev_id == dev_id) {
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80168c:	a1 90 67 80 00       	mov    0x806790,%eax
  801691:	8b 40 48             	mov    0x48(%eax),%eax
  801694:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801698:	89 44 24 04          	mov    %eax,0x4(%esp)
  80169c:	c7 04 24 ac 26 80 00 	movl   $0x8026ac,(%esp)
  8016a3:	e8 a9 eb ff ff       	call   800251 <cprintf>
	*dev = 0;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801771:	a1 90 67 80 00       	mov    0x806790,%eax
	struct Fd *fd;
	if ((r = fd_lookup(fdnum, &fd)) < 0
	    || (r = dev_lookup(fd->fd_dev_id, &dev)) < 0)
		return r;
  ...
  801781:	c7 04 24 cc 26 80 00 	movl   $0x8026cc,(%esp)
  801788:	e8 c4 ea ff ff       	call   800251 <cprintf>
  ...
  8017e1:	e8 6b fe ff ff       	call   801651 <dev_lookup>
{
  ...
  8017f3:	a1 90 67 80 00       	mov    0x806790,%eax
  8017f8:	8b 40 48             	mov    0x48(%eax),%eax
  8017fb:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8017ff:	89 44 24 04          	mov    %eax,0x4(%esp)
  801803:	c7 04 24 ed 26 80 00 	movl   $0x8026ed,(%esp)
  80180a:	e8 42 ea ff ff       	call   800251 <cprintf>
  ...
  80186a:	e8 e2 fd ff ff       	call   801651 <dev_lookup>
{
  ...
  801891:	c7 04 24 0a 27 80 00 	movl   $0x80270a,(%esp)
...
fsipc(unsigned type, void *dstva)
{
  ...
  801b6a:	89 d6                	mov    %edx,%esi
	...
	if (fsenv == 0)
  801b6c:	83 3d 00 50 80 00 00 	cmpl   $0x0,0x805000
  801b73:	75 11                	jne    801b86 <fsipc+0x2a>
		fsenv = ipc_find_env(ENV_TYPE_FS);
  801b75:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  801b7c:	e8 df 02 00 00       	call   801e60 <ipc_find_env>
  ...
  801b8d:	00 
  801b8e:	c7 44 24 08 00 70 80 	movl   $0x807000,0x8(%esp)
  801b95:	00 
  801b96:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801b9a:	a1 00 50 80 00       	mov    0x805000,%eax
  801b9f:	89 04 24             	mov    %eax,(%esp)
  801ba2:	e8 04 03 00 00       	call   801eab <ipc_send>
  ...
  801bba:	e8 6a 03 00 00       	call   801f29 <ipc_recv>
}
...
devfile_trunc(struct Fd *fd, off_t newsize)
{
  ...
  801bd5:	a3 00 70 80 00       	mov    %eax,0x807000
	fsipcbuf.set_size.req_size = newsize;
  801bda:	8b 45 0c             	mov    0xc(%ebp),%eax
  801bdd:	a3 04 70 80 00       	mov    %eax,0x807004
...
devfile_flush(struct Fd *fd)
{
  ...
  801bff:	a3 00 70 80 00       	mov    %eax,0x807000
...
devfile_stat(struct Fd *fd, struct Stat *st)
{
  ...
  801c3c:	a3 00 70 80 00       	mov    %eax,0x807000
  ...
  801c54:	c7 44 24 04 00 70 80 	movl   $0x807000,0x4(%esp)
  801c5b:	00 
  801c5c:	89 1c 24             	mov    %ebx,(%esp)
  801c5f:	e8 16 ef ff ff       	call   800b7a <strcpy>
	st->st_size = fsipcbuf.statRet.ret_size;
  801c64:	a1 80 70 80 00       	mov    0x807080,%eax
  801c69:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	st->st_isdir = fsipcbuf.statRet.ret_isdir;
  801c6f:	a1 84 70 80 00       	mov    0x807084,%eax
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801ca0:	89 15 00 70 80 00    	mov    %edx,0x807000
        fsipcbuf.write.req_n = n;
  801ca6:	a3 04 70 80 00       	mov    %eax,0x807004
        memmove(fsipcbuf.write.req_buf,buf,n);  
  801cab:	89 44 24 08          	mov    %eax,0x8(%esp)
  801caf:	8b 45 0c             	mov    0xc(%ebp),%eax
  801cb2:	89 44 24 04          	mov    %eax,0x4(%esp)
  801cb6:	c7 04 24 08 70 80 00 	movl   $0x807008,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801ce0:	a3 00 70 80 00       	mov    %eax,0x807000
        fsipcbuf.read.req_n = n;
  801ce5:	8b 45 10             	mov    0x10(%ebp),%eax
  801ce8:	a3 04 70 80 00       	mov    %eax,0x807004
  ...
  801d06:	c7 44 24 04 00 70 80 	movl   $0x807000,0x4(%esp)
  801d0d:	00 
...
remove(const char *path)
{
  ...
  801d46:	c7 04 24 00 70 80 00 	movl   $0x807000,(%esp)
...
open(const char *path, int mode)
{
  ...
  801d9e:	a3 00 74 80 00       	mov    %eax,0x807400
  ...
  801db6:	c7 04 24 00 70 80 00 	movl   $0x807000,(%esp)
...
void
_panic(const char *file, int line, const char *fmt, ...)
  801e0c:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
  ...
  801e0f:	8b 1d 70 47 80 00    	mov    0x804770,%ebx
  801e15:	e8 78 f6 ff ff       	call   801492 <sys_getenvid>
  801e1a:	8b 55 0c             	mov    0xc(%ebp),%edx
  801e1d:	89 54 24 10          	mov    %edx,0x10(%esp)
  801e21:	8b 55 08             	mov    0x8(%ebp),%edx
  801e24:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801e28:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801e2c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801e30:	c7 04 24 30 27 80 00 	movl   $0x802730,(%esp)
  801e37:	e8 15 e4 ff ff       	call   800251 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801e3c:	89 74 24 04          	mov    %esi,0x4(%esp)
  801e40:	8b 45 10             	mov    0x10(%ebp),%eax
  801e43:	89 04 24             	mov    %eax,(%esp)
  801e46:	e8 a5 e3 ff ff       	call   8001f0 <vcprintf>
	cprintf("\n");
  801e4b:	c7 04 24 24 27 80 00 	movl   $0x802724,(%esp)
  801e52:	e8 fa e3 ff ff       	call   800251 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  801e57:	cc                   	int3   
  801e58:	eb fd                	jmp    801e57 <_panic+0x53>
  801e5a:	00 00                	add    %al,(%eax)
  801e5c:	00 00                	add    %al,(%eax)
	...
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ed3:	e8 6c f2 ff ff       	call   801144 <sys_ipc_try_send>
  ...
  801ef0:	e8 4f f2 ff ff       	call   801144 <sys_ipc_try_send>
           if(ret == 0)
  ...
  801efe:	c7 44 24 08 54 27 80 	movl   $0x802754,0x8(%esp)
  801f05:	00 
  801f06:	c7 44 24 04 46 00 00 	movl   $0x46,0x4(%esp)
  801f0d:	00 
  801f0e:	c7 04 24 63 27 80 00 	movl   $0x802763,(%esp)
  801f15:	e8 ea fe ff ff       	call   801e04 <_panic>
           sys_yield();
  801f1a:	e8 f1 f4 ff ff       	call   801410 <sys_yield>
        }
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801f45:	e8 8f f1 ff ff       	call   8010d9 <sys_ipc_recv>
  801f4a:	eb 08                	jmp    801f54 <ipc_recv+0x2b>
        else
           ret = sys_ipc_recv(pg);
  801f4c:	89 04 24             	mov    %eax,(%esp)
  801f4f:	e8 85 f1 ff ff       	call   8010d9 <sys_ipc_recv>
        if(ret == 0){
  ...
  801f5c:	a1 90 67 80 00       	mov    0x806790,%eax
  ...
  801f6a:	a1 90 67 80 00       	mov    0x806790,%eax
  801f6f:	8b 40 7c             	mov    0x7c(%eax),%eax
  801f72:	89 03                	mov    %eax,(%ebx)
           return thisenv->env_ipc_value;
  801f74:	a1 90 67 80 00       	mov    0x806790,%eax
