...
umain(int argc, char **argv)
{
  ...
  800037:	83 ec 18             	sub    $0x18,%esp
	cprintf("hello, world\n");
  80003a:	c7 04 24 00 21 80 00 	movl   $0x802100,(%esp)
  ...
  800052:	c7 04 24 0e 21 80 00 	movl   $0x80210e,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  800072:	e8 fb 12 00 00       	call   801372 <sys_getenvid>
...
exit(void)
{
  ...
  8000b7:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000ba:	e8 3c 18 00 00       	call   8018fb <close_all>
	sys_env_destroy(0);
  8000bf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000c6:	e8 e7 12 00 00       	call   8013b2 <sys_env_destroy>
}
  8000cb:	c9                   	leave  
  8000cc:	c3                   	ret    
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800270:	0f be 80 2f 21 80 00 	movsbl 0x80212f(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800426:	c7 44 24 08 40 21 80 	movl   $0x802140,0x8(%esp)
  80042d:	00 
  ...
  80044c:	c7 44 24 08 49 21 80 	movl   $0x802149,0x8(%esp)
  800453:	00 
  ...
  80048a:	be 4c 21 80 00       	mov    $0x80214c,%esi
				p = "(null)";
			if (width > 0 && padc != '-')
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800789:	0f be 80 2f 21 80 00 	movsbl 0x80212f(%eax),%eax
  ...
  80083c:	00 
  80083d:	c7 44 24 08 49 21 80 	movl   $0x802149,0x8(%esp)
  800844:	00 
  ...
  800872:	00 
  800873:	c7 44 24 08 49 21 80 	movl   $0x802149,0x8(%esp)
  80087a:	00 
  ...
  800908:	0f be 80 2f 21 80 00 	movsbl 0x80212f(%eax),%eax
  ...
  80094a:	0f be 80 2f 21 80 00 	movsbl 0x80212f(%eax),%eax
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801583:	e8 a9 eb ff ff       	call   800131 <cprintf>
	*dev = 0;
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801668:	e8 c4 ea ff ff       	call   800131 <cprintf>
  ...
  8016c1:	e8 6b fe ff ff       	call   801531 <dev_lookup>
{
  ...
  8016ea:	e8 42 ea ff ff       	call   800131 <cprintf>
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  801d17:	e8 15 e4 ff ff       	call   800131 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801d1c:	89 74 24 04          	mov    %esi,0x4(%esp)
  801d20:	8b 45 10             	mov    0x10(%ebp),%eax
  801d23:	89 04 24             	mov    %eax,(%esp)
  801d26:	e8 a5 e3 ff ff       	call   8000d0 <vcprintf>
	cprintf("\n");
  801d2b:	c7 04 24 0c 21 80 00 	movl   $0x80210c,(%esp)
  801d32:	e8 fa e3 ff ff       	call   800131 <cprintf>
